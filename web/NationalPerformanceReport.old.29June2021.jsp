    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;">
            ...
            <ul class="nav nav-tabs" style="padding-top: 10px;">
                <li class='active'><a data-toggle="tab" href="#2020_21_tab" style="font-size: 12px; font-weight: bold;">2020-21</a></li>
                ...
                <li class="dropdown"><a href="#" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Download &nbsp; <span class="caret"></span></a>
                    <ul class="dropdown-menu dmenu">
                        <li><a href="DownloadNationalPerformanceSummaryReport_2020_21.jsp?exportToExcel=YES">2020-21 Current Yr Performance Report</a></li> 
                        <li><a href="DownloadNationalPerformanceSummaryReport_2019_20.jsp?exportToExcel=YES">2019-20 Last Yr Performance Report</a></li> 
                    </ul>
                </li>   
            </ul>
            <div class="tab-content">
                <div id="2020_21_tab" class="tab-pane fade in active">
