...
<html>
    <head>
        ...
        <title>2019_20 Opening Balance</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 12px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; Opening Balance 2019_20
                                    </h3>
                                </div>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String camp = "";
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "select * from v_membership_op_bal_2019_20 order by zone,state_asso,region,area,camp";
                                                    ...
                                                    while (rs1.next()) {
                                                        ...
                                                        if (state_asso == "null" || state_asso.isEmpty() || state_asso.isBlank()) {
                                                            state_asso = "";
                                                        }
