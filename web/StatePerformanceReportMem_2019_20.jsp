    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#summary_tab" style="font-size: 12px; font-weight: bold;">SA <%= v_sa_no%> -:- Memberships - Summary Report</a></li>
                <li><a data-toggle="tab" href="#detailed_tab" style="font-size: 12px; font-weight: bold;">SA <%= v_sa_no%> -:- Memberships - Detailed Report</a></li>
            </ul>
