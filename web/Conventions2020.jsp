...
<html>
    <head>
        ...
        <title>TGII | Conventions 2020</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 12px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; CONVENTIONS 2020
                                    </h3>
                                </div>
                                    ...
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                ...
                                                <th nowrap>Head Count</th>
                                                <th nowrap>Reg Fee</th>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String camp = "";
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "SELECT convention_name,name,MEMBERSHIPNO,refno,mobile,state_asso,region,area,camp,applied_on,total_persons,total_amount,status from CONVENTIONS_2020_BACKUP_FILE order by convention_name,state_asso,region,area,MEMBERSHIPNO";

                                                    Statement st1 = con.createStatement();
                                                    ResultSet rs1 = st1.executeQuery(query1);
                                                    while (rs1.next()) {
                                                        name = rs1.getString("name");
                                                        mid = rs1.getString("MEMBERSHIPNO");
                                                        refno = rs1.getString("refno");
                                                        ...
                                                        convention_name = rs1.getString("convention_name");
                                                        applied_on = rs1.getString("applied_on");
                                                        total_persons = rs1.getString("total_persons");
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap><%= phone%></td> 
                                                <td nowrap><%= refno%></td> 
                                                <td nowrap><%= applied_on %></td> 
                                                <td style="text-align: center;" nowrap><%= total_persons%></td> 
