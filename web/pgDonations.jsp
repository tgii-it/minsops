    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" class="container-fluid" style="padding: 60px 0px;">
            <ul class="nav nav-tabs">
                <li class="dropdown active"><a href="#" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Donations 2021 &nbsp; <span class="caret"></span></a>
                ...
                <li class="dropdown"><a href="#" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Donations 2020 &nbsp; <span class="caret"></span></a>
                    <ul class="dropdown-menu dmenu">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%                                        String SAN_REMARKS = "";
                                        ...
                                        try {
                                            ...
                                            String query1 = "select * from MEMBERSHIP_DONATIONS_ONLINE_ALL where NAME is not null and tgii_refno like '%2021%' and status='Success' order by icici_refno desc";
                            ...
                            <table id="2021list" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_DONATIONS_ONLINE_ALL where NAME is not null and tgii_refno like '%2021%' order by icici_refno desc";
                                            //System.out.println("MEMBERSHIP_DONATIONS_ONLINE_ALL "+query1);
                                            Statement st1 = con.createStatement();
                                            ResultSet rs1 = st1.executeQuery(query1);
                                            while (rs1.next()) {
                                                MEMBERSHIP_TYPE = rs1.getString("MEMBERSHIP_TYPE");
                            ...
                            <table id="2020successlist" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_DONATIONS_ONLINE_ALL where NAME is not null and tgii_refno like '%2020%' and status='Success' order by icici_refno desc";
                            ...
                            <table id="2020list" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_DONATIONS_ONLINE_ALL where NAME is not null and tgii_refno like '%2020%' order by icici_refno desc";
                                            //System.out.println("MEMBERSHIP_DONATIONS_ONLINE_ALL "+query1);
                                            Statement st1 = con.createStatement();
                                            ResultSet rs1 = st1.executeQuery(query1);
                                            while (rs1.next()) {
