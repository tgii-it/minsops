    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" class="container-fluid" style="padding: 60px 0px;">
            <ul class="nav nav-tabs">
                <li class="dropdown active"><a href="#" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Renewals 2021 &nbsp; <span class="caret"></span></a>
                    <ul class="dropdown-menu dmenu">
                        <li><a data-toggle="tab" href="#2021Rs_list">PG Success Transactions</a></li>
                        <li><a data-toggle="tab" href="#2021Rf_list">PG Failure Transactions</a></li>
                        <li><a data-toggle="tab" href="#2021R_list">All Records</a></li>
                    </ul>
                </li> 
                <li class="dropdown"><a href="#" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Renewals 2020 &nbsp; <span class="caret"></span></a>
                    <ul class="dropdown-menu dmenu">
            ...
            <div class="tab-content">
                    ...
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;PG Success records 2021
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2021successlist" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%                                        String SAN_REMARKS = "";
                                        ...
                                        try {
                                            ...
                                            String query1 = "select * from MEMBERSHIP_RENEWALS_ONLINE_ALL where NAME is not null and tgii_refno like '%2021R%' and status='Success' order by icici_refno desc";
                ...
                <div id="2021R_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;All records 2021
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2021list" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        <th style="text-align: center;" hidden></th>
                                        <th nowrap>CAMP</th>
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_RENEWALS_ONLINE_ALL where NAME is not null and tgii_refno like '%2021R%' order by icici_refno desc";
                                            //System.out.println("MEMBERSHIP_RENEWALS_ONLINE_ALL "+query1);
                                            Statement st1 = con.createStatement();
                                            ResultSet rs1 = st1.executeQuery(query1);
                                            while (rs1.next()) {
                                                MEMBERSHIP_TYPE = rs1.getString("MEMBERSHIP_TYPE");
                ...
                <div id="2021Rf_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;PG Failure records 2021
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2021failurelist" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        <th style="text-align: center;" hidden></th>
                                        <th nowrap>CAMP</th>
                ...
                <div id="2020Rs_list" class="tab-pane fade in"> 
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;PG Success records 2020
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2020successlist" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_RENEWALS_ONLINE_ALL where NAME is not null and tgii_refno like '%2020R%' and status='Success' order by icici_refno desc";
                ...
                <div id="2020R_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;All records 2020
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2020list" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_RENEWALS_ONLINE_ALL where NAME is not null and tgii_refno like '%2020R%' order by icici_refno desc";
                                            //System.out.println("MEMBERSHIP_RENEWALS_ONLINE_ALL "+query1);
                                            Statement st1 = con.createStatement();
                                            ResultSet rs1 = st1.executeQuery(query1);
                                            while (rs1.next()) {
                ...
                <div id="2020Rf_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;PG Failure records 2020
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                ...
                <div id="2019R_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;All records 2019
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2019list" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_RENEWALS_ONLINE_ALL where NAME is not null and tgii_refno like '%2019R%'";
                ...
                <div id="2019Rs_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;PG Success records 2019
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="2019successlist" class="table table-bordered table-responsive table-hover">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            String query1 = "select * from MEMBERSHIP_RENEWALS_ONLINE_ALL where NAME is not null and tgii_refno like '%2019R%' and status='Success' order by icici_refno desc";
                ...
                <div id="2019Rf_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp;PG Failure records 2019
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var table = $('#2021successlist,#2021failurelist,#2021list').DataTable({
                    responsive: true,
                    stateSave: true,
                    "ordering": true,
                    lengthMenu: [
