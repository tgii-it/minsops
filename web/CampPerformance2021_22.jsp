...
<html>
    <head>
        ...
        <title>2021_22 Camp Report</title>
    ...
    <body style="background-color: #fff; width: 100%;" id="myContainer">
        ...
        <section class="container-fluid" style="padding-top: 20px" > 
            <p style="font-size: 14px; font-weight: bold; color: blue; margin-left: 5px;">Camp Report : PY 2021_22</p>        
                                                                ...
                                                                <% String submitted_on = "";
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        query1 = "SELECT rid,modified_on submitted_on,e503month||'-'||e503year e503_month,initcap(camp) camp,"
                                                                                ...
                                                                                + "tallydate,nvl(tallyremarks,'-') tally_remarks FROM E503 where upper(camp) = upper('" + camp + "') order by modified_on";
        ...
        <script>
            $(function () {
                $('#camp').change(function () {
                    ...
                    var camp = $("#camp").val();
                    $.ajax({
                        url: 'CampDashboard2021?camp=' + camp,
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
