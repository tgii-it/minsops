...
<html>
    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <form name="frm2" method="post" action="RegionPerformanceReportAux.jsp" onsubmit="return FrontPage_Form1_Validator(this)">     
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#summary_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa%> -:- Auxiliary Summary Report</a></li>
                    <li><a data-toggle="tab" href="#detailed_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa%> -:- Auxiliary Detailed Report</a></li>
                </ul>
                            ...
                            <table id="summary" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">   
                                    ...
                                    <tr>                                               
                                        ...
                                        <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Aux Heart Fund</th>  
