                                ...
                                <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                    <thead style="background-color: #01354a; color: #ffe114;">
                                        <tr>
                                            ...
                                            <th colspan="4" style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center;">PENDING RECONCILIATION</th>
                                            <th colspan="4" style="background-color: #ededff; border-color: #fff; color: #01354a; text-align: center;">PAYMENT PROCESSED</th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th nowrap>Camp</th>
                                            <th style="text-align: center;" nowrap>Gideons</th>
                                            ...
                                            <th style="text-align: center;" nowrap>No_of_Records</th> 
                                        </tr>
                                    </thead>
                                    <tbody id='mytab' class="table-search"> 
                                        <%
                                            ...
                                            try {
                                                ...
                                                String sql = "select * from v_state_conventions_2021_statistics_analytics_camp_level order by sa";
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th hidden></th>
                                            <th colspan="4" style="text-align: right;">Overall Total</th>
