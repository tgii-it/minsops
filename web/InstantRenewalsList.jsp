...
<html>
    <head>
        ...
        <title>TGII | INSTANT RENEWALS DASHBOARD</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" class="container-fluid" style="padding: 60px 0px;">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#gid_list" style="font-size: 12px; font-weight: bold;">Instant Renewals</a></li>
            </ul>
                    ...
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp; Renewed List 
                            </h3>
                        </div>
                            ...
                            <table id="gideons" style="float: left; width: 100%" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        ...
                                        <th nowrap>RENEWAL_REMARKS</th>    
                                        <th nowrap>RENEWAL_PROCESSED_BY</th>    
                                        <th nowrap>RENEWAL_PROCESSED_ON</th>    
                                        <th nowrap>E503_ID</th>    
                                        <th nowrap>AMOUNT</th>   
                                        <th nowrap>PG_TR_REF_NO</th> 
                                        <th nowrap>PG_TR_STATUS</th> 
                                        <th nowrap>PG_TR_AMOUNT</th> 
        ...
        <script>
            $(document).ready(function () {
                ...
                gideons = $('#gideons').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1inst-ren/instrenewalslist/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "sa"},
                        ...
                        {"data": "record_status"},
                        {"data": "submitted_on"},
                        {"data": "renewal_remarks"},
                        {"data": "renewal_processed_by"},
                        {"data": "renewal_processed_on"},
                        {"data": "e503_id"},
                        {"data": "total_amount"},
                        {"data": "icici_refno"},
                        {"data": "icici_status"},
                        {"data": "icici_tr_amount"},
                        {"data": "annual_end_date"},
                        {"data": "basket"}
                    ], columnDefs: [
                        {className: 'text-nowrap', targets: [0, 1, 3, 6, 7, 16]}
                    ]
                });
            });
        </script>
