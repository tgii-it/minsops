...
<html>
    <head>
        ...
        <title>TGII | Process Direct Renewals Request</title>
    ...
    <body style="background-color: #fff; width: 100%;">
                ...
                <div class='panel panel-default panel-accent-gold'>
                    <div class="panel-heading" style="background-color: #fff;">
                        <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                            <i class="fa fa-fw fa-share"></i>&nbsp; Process Direct Renewals Request
                        </h3>
                    </div>

                    <form name="frm_apply" method="post" action="PendingRenewalsCampWise.jsp">
                        <div class="form-group col-md-12" style="padding-top:15px; width: 100%;">
                                ...
                                <div class='input-group'>
                                    ...
                                    <%  String camp_sql = "";
                                        ...
                                        String mcamp_str = "";
                                            ...
                                            camp_sql = "select camp,state_asso||' - Region '||region||' - Area'||area name_str from camps_master where status='Active' order by camp";
                                            ResultSet resultSet = statement.executeQuery(camp_sql);
                                    %>
                                    <input type="hidden" name="qmid" id="qmid"/>
                                    <input name="camp" list="oCamp" class="form-control" id="camp" value="<%=camp%>" style="text-align: left; background-color: #fff; height: 30px;" placeholder=".. Search & select Camp name.." rel="camp" data-html="true" title="Search and select the '<b>Camp</b>' from the list.." data-toggle="tooltip" data-placement="top"/>
                                    <datalist id="oCamp">
                                        <%
                                            while (resultSet.next()) {
                                                mcamp = resultSet.getString("camp");
                                                mcamp_str = resultSet.getString("name_str");
                                        %>
                                        <option value="<%=mcamp%>"><%=mcamp_str%></option>
                                        <%
                                            }
                                        %>
                                    </datalist>
                    ...
                    <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; color: black; height: auto;">
                        <form name="frm_apply" method="post" action="ProcessE503RenewalRequest" onsubmit="return validateCheckbox(this)">
                            <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        <th style="text-align: left;"><a href="javascript:selectToggle(true, 'frm_apply');" style="color: #fff;"><b>All</b></a> | <a href="javascript:selectToggle(false, 'frm_apply');" style="color: #fff;"><b>None</b></a><br>MID</th>
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            Statement statement = con.createStatement();
                                            String sql = "select to_char(annual_start_date,'dd-mm-yyyy') annual_start_date, to_char(annual_end_date,'dd-mm-yyyy') annual_end_date, a.* from membership_weekly_raw a where upper(a.camp)=Upper('" + camp + "') and mtype like '%Annual%' and annual_end_date='31-10-20' order by mid";
                ...
                <div class='panel panel-default panel-accent-gold'>
                    ...
                    <div class="panel-body" style="padding-top: 20px;"> 
                        <div class="form-row">                                       
                            <div class="form-group col-md-3">
                                ...
                                <div class='input-group'>
                                    ...
                                    <select name="renewalStatus" id="renewalStatus" class="form-control" required >
                                        ...
                                        <option value="Renewed_PTP Confirmed">- PTP Confirmed -</option>
                                        <option value="Renewed_WTR Confirmed">- WTR Confirmed -</option>
                            ...
                            <div class="form-group col-md-2" id="efrom">
                                <label for="enddate">End Date (From)</label>
                                <div class='input-group date' id='end_date_from'>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                    <input type='text' class="form-control" name="enddatefrom" id="enddatefrom" placeholder="DD/MM/YYYY" autocomplete="off" required/>
                                </div>
                            </div> 
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class='input-group'>
                                    ...
                                    <input type="hidden" name="redirect" id="redirect" value="PendingRenewalsCampWise"/>
        ...
        <script>
            ...
            $("#end_date_from").datepicker().datepicker("setDate", "31/10/2020");
        </script>
