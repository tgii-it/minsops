...
<html>
    <head>
        ...
        <title>Camp Officers Master</title>
    ...
    <body class="container-fluid" style="background-color: #fff; width: 100%;" >  
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 12px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; CAMP OFFICERS LIST
                                    ...
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                ...
                                                <th style="text-align: center;" nowrap>M ID</th>
                                                <th style="text-align: left;" nowrap>M Type</th>
                                                <th style="text-align: left;" nowrap>M Status</th>
                                                <th style="text-align: left;" nowrap>M Validity</th>
                                                <th style="text-align: center;" nowrap>Mobile</th>
                                                <th style="text-align: left;" nowrap>Email ID</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "select case when a.phone is not null then a.phone else a.mobile end phoneNo,a.*,b.mtype,to_char(b.annual_end_date,'dd-mm-yy') mend_date,b.status mstatus from GMAP_ALL_OFFICERS a, Membership_weekly_raw b where upper(a.mid) = upper(b.mid) and UPPER(a.DESIGNATION) LIKE '%CAMP%' order by a.gid_aux asc";
                                            ...
                                            %> 
                                            <tr style='cursor: pointer;' title='Click here to Update' data-toggle="modal" data-target="#myModal" onclick="update('<%out.print(mid);%>', '<%out.print(designation);%>')">                                               
                        ...
                        <div class='panel panel-default panel-accent-gold'>
                            <div class="panel-heading" style="background-color: #fff;">
                                <h3 class="panel-title" style="vertical-align: middle; font-size: 13px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                    <i class="fa fa-fw fa-share"></i>&nbsp; MODIFY RECORD <%=mid%>
                                </h3>
                            </div>
                            <div class="panel-body" style="padding-top: 20px;"> 
                                <div class="form-row">                                          
                                        ...
                                        <div class='input-group'>
                                            ...
                                            <%  String gideon_sql = "";
                                                ...
                                                try {
                                                    ...
                                                    gideon_sql = "select distinct designation from gmap_all_officers order by designation";
                                                    ResultSet resultSet = statement.executeQuery(gideon_sql);
                                            %>
                                            <input type="hidden" name="oDesignatoin" id="oDesignation">
                                            <input name="designation" list="mDesignation" class="form-control" id="designation">
                                            <datalist id="mDesignation">
                                                <%
                                    ...
                                    <div class="form-group col-md-9" >
                                        <label for="namestr">Search & select the New Officer</label>
                                        <div class='input-group'>
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-list"></span>
                                            </span>
                                            <%  String name_sql = "";
                                                ...
                                                try {
                                                    con = ds.getConnection();
                                                    Statement statement = con.createStatement();
                                                    name_sql = "select distinct name,name||' - '||mid||' - '||camp||' - '||phone||' - '||email||' - '||status name_str from membership_weekly_raw where upper(status) in ('CURRENT','GRACE') order by name";

                                                    ResultSet resultSet = statement.executeQuery(name_sql);
                                            %>
                                            <input name="mName" list="oName" class="form-control" id="mName">
                                            <datalist id="oName">
                                                <%
                                                    while (resultSet.next()) {
                                                ...
                                                %>
                                                <option value="<%=mname_str%>"><%=mname%></option>
                                                <%
                                                    }
                                                %>
                                            </datalist>
                                    ...
                                    <div class="form-group col-md-1">
                                        <label for="contactperson">Mem ID</label>
                                        <div class='input-group'>
                                            <input type='text' class="form-control" name="memid" id="memid" maxlength="8"/>
                                        </div>                                            
                                    </div>  
                                    <div class="form-group col-md-2">
                                        <label for="contactperson">Mobile</label>
                                        <div class='input-group'>
                                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group col-md-3" >
                                        <label for="memtype">State Association</label>
                                        <div class='input-group'>
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-list"></span>
                                            </span> 
                                            <select class="form-control" id="state_asso" name="state_asso">
        ...
        <script>
            $(document).on('click', '.final-submit', function () {
                ...
                var result = "";
                if (mid === "--" || mid === "") {
                    var v_Url = 'StateOfficersInsertMIDsave.jsp?action=Insert&memid=' + memid + '&name=' + name + '&camp=' + camp + '&mobile=' + mobile + '&email=' + email + '&remarks=' + remarks + '&region=' + region + '&area=' + area + '&email=' + email + '&state_asso=' + state_asso + '&zone=' + zone + '&designation=' + designation
                } else {
                    var v_Url = 'StateOfficersEditMIDsave.jsp?action=Update&mid=' + mid + '&memid=' + memid + '&name=' + name + '&camp=' + camp + '&mobile=' + mobile + '&email=' + email + '&remarks=' + remarks + '&region=' + region + '&area=' + area + '&email=' + email + '&state_asso=' + state_asso + '&zone=' + zone + '&designation=' + designation + '&oDesignation=' + oDesignation
                }
