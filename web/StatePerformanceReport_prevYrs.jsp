            ...
            <div class='panel panel-default panel-accent-gold'>
                <div class="panel-heading" style="background-color: #fff;">
                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                        <i class="fa fa-fw fa-share"></i>&nbsp; <%=v_sa_display%> <font style="color: brown;">Previous Years</font> Performance Reports
                    </h3>
                </div>
                <div class="panel-body" style="padding-top: 10px; width: 100%"> 
                    <ul class="nav nav-tabs">                        
                        ...
                        <li class="dropdown"><a href="#detailed_tab" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Download &nbsp; <span class="caret"></span></a>
                            <ul class="dropdown-menu dmenu">                                
                                ...
                                <li><a href="DownloadStatePerformanceInactiveDetailedReport_2020_21.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2022-23 In-Active Camps Report</a></li>
                                <li class="divider"></li>
                                <li><a href="DownloadStatePerformanceSummaryReport_2019_20.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2021-22 Summary Report</a></li>
                                <li><a href="DownloadStatePerformanceDetailedReport_2019_20.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2021-22 Detailed Report</a></li>
                                <li><a href="DownloadStatePerformanceInactiveDetailedReport_2019_20.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2021-22 In-Active Camps Report</a></li>
                                <li class="divider"></li>
                                <li><a href="DownloadStatePerformanceSummaryReport_2019_20.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2020-21 Summary Report</a></li>
                                <li><a href="DownloadStatePerformanceDetailedReport_2019_20.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2020-21 Detailed Report</a></li>
                                <li><a href="DownloadStatePerformanceInactiveDetailedReport_2019_20.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2020-21 In-Active Camps Report</a></li>
                                <li class="divider"></li>
                    ...
                    <div class="tab-content">
                        <!-- 2022 - 23 Performance year report -->
                                        ...
                                        <table id="summary" class="table table-bordered table-responsive table-hover">
                                            <thead style="background-color: #01354a; color: #ffe114;">   
                                                ...
                                                <tr>                                               
                                                    ...
                                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Gideon<br>Opening<br>Balance as on<br>31 May 2023</th> 
                                                    ...
                                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Auxiliary<br>Opening<br>Balance as on<br>31 May 2023</th> 
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    sql = "select no_of_camps,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo, "
                                                            ...
                                                            + "a.* from STATE_SUMMARY_REPORT_C_2022_23  a where sa_no='" + v_sa_no + "' and decode(region,'SA_Total','94','Inactive Camps','95','PWT SF','96','SA_Suspense','97','Total','98',region)>0 order by sa_no,region,to_number(decode(area,'Region_Total','19','-','20',area)) asc";
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    sql = "select (select status from camps_master where upper(camp)=upper(a.camp)) camp_status,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                            ...
                                                            + "a.* from STATE_Detailed_Report_22_23fa a where sa_no='" + v_sa_no + "' and decode(a.region,'SA_Total','94','Inactive Camps','95','PWT SF','96','SA_Suspense','97','Total','98',a.region)>0 order by sa_no,a.region,to_number(decode(area,'Region_Total','19','-','20',area)) asc,camp";
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    sql = "select (nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                            ...
                                                            + "a.* from STATE_INACTIVE_REPORT_C_2022_23 a where sa_no='" + v_sa_no + "' and decode(a.region,'SA_Total','95','All_Above_Total','95','Inactive Camps','96','SA_Suspense','97','Total','98',a.region)>0 AND REGION<>'SA_Total' order by sa_no,a.region,area,camp";
                        ...
                        <div id="PY2021-22" class="tab-pane fade">
                            ...
                            <p style="padding-left: 10px; font-size: 12px; margin-top:10px; color: #337ab7;"><b>Note :</b> Final report of PY 2021-22</p>
                            <div class="tab-content">
