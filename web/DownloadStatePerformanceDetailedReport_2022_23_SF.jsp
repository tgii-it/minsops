...
<%
    ...
    try {
        ...
        while (resultSet.next()) {
            filename = "SA-" + v_sa_no + "-SF Detailed Report " + resultSet.getString("downloaded_on") + ".xls";
        }
        resultSet.close();
        stmt.close();
        con.close();
            ...
            <div id="content">
                <div class="table-responsive" style="vertical-align: middle; height: 480px; background-color: #fff;">
                    <table id="summary" class="table table-bordered table-responsive table-hover" border="1">
                        ...
                        <thead style="background-color: #01354a; color: #ffe114;">   
                            <tr>
                                <th colspan="34" style="background-color: yellow; border-color: #fff; color: #01354a; text-align: left;"><h3><B>SA <%=v_sa_no%> - 2021-22 SF PERFORMANCE REPORT - DETAILED</B></h3></th>
                            </tr>  
