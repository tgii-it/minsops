...
<%
    ...
    try {
        ...
        while (resultSet.next()) {
            filename = "2023_24_National_Perf_Report_" + resultSet.getString("downloaded_on") + ".xls";
        }
        resultSet.close();
        stmt.close();
    } catch (Exception e) {
                ...
                <div class="table-responsive" style="vertical-align: middle; background-color: #fff;">
                    <table id="summary" class="table table-bordered table-responsive table-hover" border="1">
                        <thead style="background-color: #01354a; color: #ffe114;">  
                            <tr>
                                <th colspan="101" style="background-color: yellow; border-color: #fff; color: #01354a; text-align: left;"><h3><B>NATIONAL PERFORMANCE REPORT : PY 2023-24</B></h3></th>
                            </tr>     
                            <tr>
