                        ...
                        <div class='panel panel-default panel-accent-gold'>
                            <div class="panel-heading" style="background-color: #fff;">
                                <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                    <i class="fa fa-fw fa-share"></i>&nbsp;National Convention Registrations
                                </h3>
                            </div>
                                    ...
                                    <tbody id='mytab' class="table-search"> 
                                        <%
                                            ...
                                            try {
                                                ...
                                                String sql = "select A.*,"
                                                        + "(gideons_processed + couple_processed/2) Tgidr, (auxiliary_processed + couple_processed/2) Tauxr, "
                                                        + "(gideons_pending + couple_pending/2) Tgidp, (auxiliary_pending + couple_pending/2) Tauxp, "
                                                        + "(gideons_pending + couple_pending + auxiliary_pending) Tp, "
                                                        + "(gideons_processed + couple_processed + auxiliary_processed) Tr, "
                                                        + "(gideons_pending + couple_pending + auxiliary_pending + gideons_processed + auxiliary_processed + couple_processed) oT "
                                                        + "from V_NATIONAL_CONVENTIONS_2021_STATISTICS_ANALYTICS A order by sa";
                                                ...
                                                while (resultSet.next()) {
                                                    ...
                                                    Tgidp = resultSet.getString("Tgidp");
                                                    Tauxp = resultSet.getString("Tauxp");
                                                    Tgidr = resultSet.getString("Tgidr");
                                                    Tauxr = resultSet.getString("Tauxr");
                                                    Tp = resultSet.getString("Tp");
                                                    Tr = resultSet.getString("Tr");
