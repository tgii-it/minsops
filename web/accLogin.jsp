...
<html>
    <head>
        ...
        <title>TGII | Memberships Module</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 80px 0px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-center" style="color: #01354a; font-weight: bold;">Membership Department - MIS Module<br><small style="color: #01354a; font-weight: bold;">Account Login</small></h3>
                    </div>
                    <div class="col-md-4 col-md-offset-4" style="color: #01354a;">
                        <form id="login" class="well"  method="post" name="frmLogin" action="myAccLogin" onsubmit="return submitForm();">
                            <div class="form-group">
                                <label>User ID</label>
                                <input type="text" class="form-control" placeholder="Enter Username" name="txtUserName" id="txtUserName" required="" autocomplete="off" autofocus>
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" class="form-control" placeholder="Password" name="password" id="password" required="" autocomplete="off">
                                <input type="hidden" class="form-control" name="passId" value="@cc0unts2o!9">
                            </div>
                            <button type="submit" class="btn btn-default btn-block btn-primary" style="color: #fff; font-weight: bold;">Sign In</button>
                        </form>
                    </div>
                </div>
            </div>
