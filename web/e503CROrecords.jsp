...
<html>
    ...
    <body class="container-fluid" style="background-color: #fff; width: 100%;" >      
        ...
        <section class="container-fluid" style="padding: 60px 0px;" >  
            <form name="frm2" id="frm2" method="post" action="e503CROrecords.jsp" >  
                <div class='panel panel-default panel-accent-gold'>
                    <div class="panel-heading" style="background-color: #fff;">
                        <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                            <i class="fa fa-fw fa-share"></i>&nbsp;e503 : CRO details Extraction
                        </h3>
                    </div>
                        ...
                        <table id="comp_table" class="table table-bordered table-responsive table-hover" style="width:100%; font-size: 10px; color: navy; ">
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    sql = "select A.*,TO_CHAR(SUBMITTED_ON,'DD-MM-YY') SDATE FROM V_E503_CRO A "
                                            + "WHERE to_date(SUBMITTED_ON,'DD-MM-YY') between to_date('" + fdate + "','DD/MM/YYYY') and to_date('" + todate + "','DD/MM/YYYY') "
                                            + "order by RID";
//                                    System.out.println("E503CROQUERY : "+sql);
                            ...
                            <tr> 
                                ...
                                <td style="text-align: center;" nowrap><%=resultSet.getString("cp_cnt")%></td>
