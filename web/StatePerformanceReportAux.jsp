...
<html>
    <head>
        ...
        <title>Auxiliary Performance Report</title> 
    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#summary_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa_no1%> -:- Auxiliary - Summary Report</a></li>
                <li><a data-toggle="tab" href="#detailed_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa_no1%> -:- Auxiliary - Detailed Report</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dmenu">
                        <li><a href="DownloadStatePerformanceSummaryReport_2023_24_Aux.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2023-24 Auxiliary Summary Report</a></li>
                        <li><a href="DownloadStatePerformanceDetailedReport_2023_24_Aux.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2023-24 Auxiliary Detailed Report</a></li>
                    </ul>
                </li>
            </ul>
                    ...
                    <div class="table-responsive" style="vertical-align: middle; font-size: 10px; height: 590px; background-color: #fff; overflow-y: scroll;">
                        <table id="summary" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                <tr>
                                    <th colspan="4" style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px; background-color: lightpink; border-color: #fff; color: #01354a;">&nbsp;</th>
                                ...
                                <tr>                                               
                                    ...
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>01 Oct 2022</th> 
