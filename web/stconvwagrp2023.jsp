...
<html>
    <head>
        ...
        <title>SASC 2023 | Registrations</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp;State Convention Registrations 2023 (Real-time data)
                                    </h3>
                                </div>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String gid = "";
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select * from v_state_conventions_2023_all_records_1 order by to_number(substr(decode(STATE_ASSOCIATION,'Outreach States (Bihar Jharkhand)','SA14',STATE_ASSOCIATION),3,2)) asc,region,area,RECORD_ID";
