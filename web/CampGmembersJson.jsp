...
<%  String camps = "";
    ...
    try {
        ...
        camps = "SELECT MID,NAME,(ltrim(name)||' - '||mid||' - '||nvl(phone,'xxxxxxxxxx')||' - '||InitCap(camp)||' - '||email) name_str,CAMP,'2' sa_no FROM MEMBERSHIP_WEEKLY_RAW a WHERE mtype like '%Gideon%Annual%' and Upper(camp)=Upper('" + request.getParameter("camp") + "')  AND status in ('Current','Pending','Grace','Dropped') ORDER BY MID";
