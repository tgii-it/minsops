                        ...
                        <div class='panel panel-default panel-accent-gold'>
                            <div class="panel-heading" style="background-color: #fff;">
                                <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                    <i class="fa fa-fw fa-share"></i>&nbsp;All State Convention Registrations
                                </h3>
                            </div>
                                ...
                                <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                    <thead style="background-color: #01354a; color: #ffe114;">
                                        <tr>
                                            ...
                                            <th colspan="5" style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center;">PENDING RECONCILIATION</th>
                                            <th colspan="5" style="background-color: #ededff; border-color: #fff; color: #01354a; text-align: center;">PAYMENT PROCESSED</th>
                                        </tr>
                                        <tr>
                                            <th hidden nowrap>Sl_No</th>
                                            <th nowrap>State Association</th>
                                            <th style="text-align: center;" nowrap>Gideon</th>
                                            <th style="text-align: center;" nowrap>Auxiliary</th>
                                            <th style="text-align: center;" nowrap>Family</th>  
                                            <th style="text-align: center;" nowrap>PAB</th>  
                                    ...
                                    <tbody id='mytab' class="table-search"> 
                                        <%
                                            ...
                                            try {
                                                ...
                                                //  String sql = "select * from v_state_conventions_2022_statistics_analytics order by sa";
                                                String sql = "select * from V_STATE_CONVENTION_2022_CAMP_WISE_REPORT_2 order by rno";
                                                ResultSet resultSet = statement.executeQuery(sql);
                                                while (resultSet.next()) {
                                                    sa = resultSet.getString("sa_no");
                                                    state_association = resultSet.getString("state_asso");
                                                    gideons_pending = resultSet.getString("gid_pending");
                                                    auxiliary_pending = resultSet.getString("aux_pending");
                                                    family_pending = resultSet.getString("f_pending");
                                                    pab_pending = resultSet.getString("pab_pending");
                                                    total_pending = resultSet.getString("pending_total");
                                                    gideons_processed = resultSet.getString("gid_processed");
                                                    auxiliary_processed = resultSet.getString("aux_processed");
                                                    family_processed = resultSet.getString("f_processed");
                                                    pab_processed = resultSet.getString("pab_processed");
                                                    total_processed = resultSet.getString("processed_total");
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;" nowrap><%=family_pending%></td>
                                            <td style="text-align: center;" nowrap><%=pab_pending%></td>
                                            <td style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=total_pending%></td>
                                            <td style="text-align: center;" nowrap><%=gideons_processed%></td>
                                            <td style="text-align: center;" nowrap><%=auxiliary_processed%></td>
                                            <td style="text-align: center;" nowrap><%=family_processed%></td>
                                            <td style="text-align: center;" nowrap><%=pab_processed%></td>
                                            <td style="background-color: #ededff; border-color: #fff; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=total_processed%></td>
                                            <td style="text-align: center; background-color: yellow; font-weight: bold;" nowrap><%=overall_total%></td>
                                            <%
                                                    }
                                                    con.close();
                                                } catch (Exception e) {
