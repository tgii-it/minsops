...
<html>
    <head>
        ...
        <title>State Conventions 2022 | Contributions</title>
                        ...
                        <div class='panel panel-default panel-accent-gold'>
                            <div class="panel-heading" style="background-color: #fff;">
                                <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                    <i class="fa fa-fw fa-share"></i>&nbsp;State Convention Contribution 2022
                                </h3>
                            </div>
                                ...
                                <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                    <thead style="background-color: #01354a; color: #ffe114;">
                                        <tr>
                                            ...
                                            <th nowrap>CAMP</th>  
                                            <th style="text-align: center;" nowrap>CD100</th>  
                                            <th style="text-align: center;" nowrap>HEART_FUND</th>
                                            <th style="text-align: center;" nowrap>SPL_OFFERING</th>
                                            <th style="text-align: center;" nowrap>LUNCHEON</th>
                                            <th style="text-align: center;" nowrap>PAB</th>
                                            <th style="text-align: center;" nowrap>Status</th>
                                            <th style="text-align: center;" nowrap>Entered_on</th>   
                                            <th style="text-align: center;" nowrap>Entered_by</th>  
                                        </tr>
                                    </thead>
                                    <tbody id='mytab' class="table-search"> 
                                        <%
                                            ...
                                            try {
                                                ...
                                                String sql = "select * from v_state_convention_2022_e503_entities order by zone,sa_no,region,area,camp";
                                                ResultSet resultSet = statement.executeQuery(sql);
                                                while (resultSet.next()) {
                                                    zone = resultSet.getString("zone");
                                                    sa = resultSet.getString("sa_no");
                                                    state_association = resultSet.getString("state_asso");
                                                    gideons_pending = resultSet.getString("region");
                                                    auxiliary_pending = resultSet.getString("area");
                                                    family_pending = resultSet.getString("camp");
                                                    pab_pending = resultSet.getString("cd100");
                                                    total_pending = resultSet.getString("heart_fund");
                                                    gideons_processed = resultSet.getString("spl_offering");
                                                    auxiliary_processed = resultSet.getString("luncheon");
                                                    family_processed = resultSet.getString("pab");
                                                    pab_processed = resultSet.getString("status");
                                                    total_processed = resultSet.getString("entered_on");
                                                    overall_total = resultSet.getString("entered_by");
                                        %>
                                        <tr>
                                            ...
                                            <td nowrap><%=family_pending%></td>
                                            <td style="text-align: center;" nowrap><%=pab_pending%></td>
                                            <td style="text-align: center;" nowrap><%=total_pending%></td>
                                            ...
                                            <td style="text-align: center;" nowrap><%=total_processed%></td>
                                            <td style="text-align: center;" nowrap><%=overall_total%></td>
                                            <%
                                                    }
                                                    con.close();
                                                } catch (Exception e) {
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th hidden></th>
                                            <th colspan="5" style="background-color: #F2FAD8; color: #01354a; font-weight: bold; text-align: right;">Page Total<br>(Overall Total)</th>
            ...
            $(document).ready(function () {
                var table = $('#gideon').DataTable({
                    ...
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        // Update footer       
                        $(api.column(6).footer()).html('' + pageTotal6 + '<br>(' + total6 + ')');
