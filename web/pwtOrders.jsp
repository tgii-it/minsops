    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form name="frm_apply" method="post" action="ProcessPwtRequest" onsubmit="return validateCheckbox(this)">
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; PWT Orders
                                        <!--<a type='button' class="pull-right" href="OtherRenewals.jsp" title='Show Other Renewals' style="font-size: 11px; letter-spacing: 2px;"><i class='fa fa-comments-o' aria-hidden='true'>&nbsp; <b>Other Renewals</b></i></a>&nbsp; &nbsp; &nbsp;
                                ...
                                <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; color: black; height: auto;">
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                <th><a href="javascript:selectToggle(true, 'frm_apply');" style="color: #fff;"><b>All</b></a> | <a href="javascript:selectToggle(false, 'frm_apply');" style="color: #fff;"><b>None</b></a><br>Record ID</th>
                                                ...
                                                <th nowrap>PWT_Total</th>    
                                                <th nowrap>Total_Amount</th> 
                                                <th nowrap>Requested_on</th> 
                                                <th nowrap>Record_Status</th>    
                                                <th nowrap>Payment_Mode</th>    
                                                <th nowrap>Transaction_Details</th> 
                                                <th nowrap>Receiver_MID</th>
                                                <th nowrap>Receiver_Name</th>
                                                <th nowrap>Receiver_Phone</th>
                                                <th nowrap>Receiver_Email</th>
                                                <th nowrap>Receiver_Address</th>   
                                                <th nowrap>PWT_Gideon_Count</th>    
                                                <th nowrap>PWT_Gideon_Amount</th>    
                                                <th nowrap>PWT_Aux_Count</th>    
                                                <th nowrap>PWT_Aux_Amount</th>    
                                                <th nowrap>PWT_HB_Count</th>    
                                                <th nowrap>PWT_HB_Amount</th>    
                                                <th nowrap>PWT_LB_Count</th>    
                                                <th nowrap>PWT_LB_Amount</th> 
                                            </tr>
                                        </thead>
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String mid = "";
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select * from v_pwt_online_transaction_list order by mid desc,rid asc";
                                                    ResultSet resultSet = statement.executeQuery(sql);
                                                    while (resultSet.next()) {
                                                        cmrid = resultSet.getString("cmrid");
                                                        ...
                                                        requested_on = resultSet.getString("requested_on");
                                                        rmid = resultSet.getString("receiver_member_id");
                                                        rname = resultSet.getString("receiver_name");
                                                        rphone = resultSet.getString("receiver_phone");
                                                        remail = resultSet.getString("receiver_email");
                                                        raddress = resultSet.getString("receiver_address");
                                                        pwtgcnt = resultSet.getString("pwtgcnt");
                                                        pwtgamount = resultSet.getString("pwtgamount");
                                                        pwtacnt = resultSet.getString("pwtacnt");
                                                        pwtaamount = resultSet.getString("pwtaamount");
                                                        pwthbcnt = resultSet.getString("pwthbcnt");
                                                        pwthbamount = resultSet.getString("pwthbamount");
                                                        pwtlbcnt = resultSet.getString("pwtlbcnt");
                                                        pwtlbamount = resultSet.getString("pwtlbamount");
                                                        pwtcnt = resultSet.getString("pwtcnt");
                                                        pwtamount = resultSet.getString("pwtamount");
                                                        record_status = resultSet.getString("record_status");
                                                        pay_mode = resultSet.getString("pay_mode");
                                                        trno = resultSet.getString("trno");
                                                        if (requested_on == null) {
                                                            requested_on = "NA";
                                                        }
                                                        if (pay_mode == null || pay_mode == "null" || pay_mode.equalsIgnoreCase("null")) {
                                                            pay_mode = "NA";
                                                        }
                                                        if (trno == null || trno == "null" || trno.equalsIgnoreCase("null")) {
                                                            trno = "NA";
                                                        }
                                                        if (record_status.equalsIgnoreCase("Processed")) {
                                            %>
                                            <tr style="background-color: greenyellow;">
                                                <td nowrap><%= mid%>-<%= rid%></td>
                                                ...
                                                <td nowrap><%=color%></td>
                                                <td style="text-align: center;" nowrap><%=qty%></td>
                                                <td style="text-align: center;" nowrap><%=pwtcnt%></td>
                                                <td style="text-align: center;" nowrap><%=pwtamount%></td>
                                                <td nowrap><%=requested_on%></td>
                                                <td nowrap><%=record_status%></td>
                                                <td nowrap><%=pay_mode%></td>
                                                <td nowrap><%=trno%></td>
                                                <td style="text-align: center;" nowrap><%=rmid%></td>
                                                <td nowrap><%=rname%></td>
                                                <td nowrap><%=rphone%></td>
                                                <td nowrap><%=remail%></td>
                                                <td nowrap><%=raddress%></td>
                                                <td style="text-align: center;" nowrap><%=pwtgcnt%></td>
                                                <td style="text-align: center;" nowrap><%=pwtgamount%></td>
                                                <td style="text-align: center;" nowrap><%=pwtacnt%></td>
                                                <td style="text-align: center;" nowrap><%=pwtaamount%></td>
                                                <td style="text-align: center;" nowrap><%=pwthbcnt%></td>
                                                <td style="text-align: center;" nowrap><%=pwthbamount%></td>
                                                <td style="text-align: center;" nowrap><%=pwtlbcnt%></td>
                                                <td style="text-align: center;" nowrap><%=pwtlbamount%></td>
                                            </tr>
                                            <%
                                            } else {
                                            %>
                                    ...
                                    <div class="form-row">                                       
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class='input-group'>
                                                ...
                                                <select name="status" id="status" class="form-control" required >
                                                    ...
                                                    <option value="Test">- Test Entry -</option>
                                        ...
                                        <div class="form-group col-md-9">
                                            ...
                                            <div class='input-group'>
                                                ...
                                                <input type='hidden' class="form-control" name="username" id="username" value="<%= useraccessname%>"/>
                                            </div>                                            
                                        </div>
