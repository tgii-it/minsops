                        ...
                        <table id="2021_22" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>    
                                    ...
                                    <th style="text-align: center; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Gideons Annual 2021 (C-YTR)</th>           
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Actual Net Gideons [(A+B)-C]</th> 
                                    ...
                                    <th style="text-align: center; background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Auxiliary Annual 2021 (C-YTR)</th>           
                                    <th style="text-align: right; background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Actual Net Auxiliary [(A+B)-C]</th> 
                            ...
                            <tbody>
                                <%
                                    ...
                                    try {
                                        ...
                                        sql = "select rownum slno,nvl(pwt_sf,'0') pwt_sf,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                ...
                                                + "a.* from V_E503_NATIONAL_SUM_REPORT_B1 a order by zone,sa_no";
                                ...
                                <tr style="color: navy;">
                                    ...
                                    <td style="text-align: center;" nowrap><%=f.format(tgytr)%></td>
                                    <td style="text-align: center;" nowrap><%=f.format(pgytr)%>&nbsp;%</td> 
                                    ...
                                    <td style="text-align: center;" nowrap><%=f.format(taytr)%></td>
                                    <td style="text-align: center;" nowrap><%=f.format(paytr)%>&nbsp;%</td> 
