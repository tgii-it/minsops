...
<html>
    <head>
        ...
        <title>TGII | Membership Module</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 80px 0px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-center" style="color: #01354a; font-weight: bold;">Membership Information System<br><small style="color: #01354a; font-weight: bold;">Account Login</small></h3>
                    </div>
                    <div class="col-md-4 col-md-offset-4" style="color: #01354a;">
                        <form id="login" class="well"  method="post" name="frmLogin" action="myMisLogin" onsubmit="return submitForm();">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="passId" value="SDl0gin">
                            </div>
