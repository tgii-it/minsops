    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#summary_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa_no1%> -:- Scripture Fund - Summary Report</a></li>
                <li><a data-toggle="tab" href="#detailed_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa_no1%> -:- Scripture Fund - Detailed Report</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dmenu">
                        <li><a href="DownloadStatePerformanceSummaryReport_2023_24_SF.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2023-24 SF Summary Report</a></li>
                        <li><a href="DownloadStatePerformanceDetailedReport_2023_24_SF.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2023-24 SF Detailed Report</a></li>
                    </ul>
                </li>
            </ul>
                        ...
                        <table id="summary" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>                                               
                                    ...
                                    <th style="text-align: right;" nowrap>Event</th>
                                    <th style="text-align: right;" nowrap>Goal</th>
                                    <th style="text-align: right;" nowrap>Actual</th>
                                    <th style="text-align: right;" nowrap>%</th>
