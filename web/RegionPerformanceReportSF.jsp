...
<html>
    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <form name="frm2" method="post" action="RegionPerformanceReportSF.jsp" onsubmit="return FrontPage_Form1_Validator(this)">     
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#summary_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa%> -:- Scripture Fund - Summary Report</a></li>
                    <li><a data-toggle="tab" href="#detailed_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa%> -:- Scripture Fund - Detailed Report</a></li>
                </ul>
                        ...
                        <div class="table-responsive" style="vertical-align: middle; font-size: 10px; height: 480px; background-color: #fff; overflow-y: scroll;">
                            <table id="summary" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">   
                                    <tr>
                                        <th colspan="4">&nbsp;</th>
                                        <th colspan="3"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">Total Scripture Fund</th>
                                        <th colspan="3"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">Number of Church Presentations</th>
                                        <th colspan="3"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">Church Retiring Offertory</th>
                                        <th colspan="4"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">GideonCard Bible Program</th>
                                        <th colspan="4"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">Pastor's Appreciation Banquet</th>
                                        <th colspan="4"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">Faith Fund Rally</th>
                                        <th colspan="3"  style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">Faith Fund Gideon</th>
                                        <th colspan="5" style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px;">&nbsp;</th>
                                    </tr>                                                            
                                    <tr>                                               
                                        ...
                                        <th style="text-align: right;" >SF<br>Actual</th> 
                                        <th style="text-align: right;" >SF<br>Goal</th> 
                                        <th style="text-align: right;" nowrap>SF %</th> 
                                        <th style="text-align: right;" nowrap>CP<br>Actual</th>              
                                        <th style="text-align: right;" nowrap>CP<br>Goal</th>
                                        <th style="text-align: right;" nowrap>CP %</th>
                                        <th style="text-align: right;" nowrap>CRO<br>Actual</th>
                                        <th style="text-align: right;" nowrap>CRO<br>Goal</th>
                                        <th style="text-align: right;" nowrap>CRO %</th>
                                        <th style="text-align: right;" nowrap>Donor</th>
                                        <th style="text-align: right;" nowrap>GCBP<br>Actual</th>
                                        <th style="text-align: right;" nowrap>GCBP<br>Goal</th>
                                        <th style="text-align: right;" nowrap>GCBP %</th>
                                        <th style="text-align: right;" nowrap>PAB<br>Event</th>
                                        <th style="text-align: right;" nowrap>PAB<br>Actual</th>
                                        <th style="text-align: right;" nowrap>PAB<br>Goal</th>
                                        <th style="text-align: right;" nowrap>PAB %</th>
                                        <th style="text-align: right;" nowrap>FFR<br>Event</th>
                                        <th style="text-align: right;" nowrap>FFR<br>Actual</th>
                                        <th style="text-align: right;" nowrap>FFR<br>Goal</th>
                                        <th style="text-align: right;" nowrap>FFR %</th>
                                        <th style="text-align: right;" nowrap>FFG<br>Actual</th>
                                        <th style="text-align: right;" nowrap>FFG<br>Goal</th>
                                        <th style="text-align: right;" nowrap>FFG %</th>
