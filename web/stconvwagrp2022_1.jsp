...
<html>
    <head>
        ...
        <title>SASC 2022 | Registrations</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp;All State Convention Registrations (Real-time data)
                                    </h3>
                                </div>
                                    ...
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String gmid = "";
                                                ...
                                                String wa_status = "";
                                                String wa_remarks = "";
                                                String wa_processed_on = "";
                                                String wa_processed_by = "";
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select * from V_STATE_CONVENTIONS_2022_4_WHATSAPP_GROUP where rid<>'0' order by state_association,region,area,camp,rid";
                                                    ResultSet resultSet = statement.executeQuery(sql);
                                                    while (resultSet.next()) {
                                                        gidmobile = resultSet.getString("gidmobile");
                                                        auxmobile = resultSet.getString("auxmobile");
                                                        wname = resultSet.getString("rwifename");
                                                        gname = resultSet.getString("gideonname");
                                                        gmid = resultSet.getString("gmid");
                                                        amid = resultSet.getString("amid");
                                                        tr_date_time = resultSet.getString("tr_date_time");
                                                        remarks = resultSet.getString("trremarks");
                                                        if (gidmobile == null || gidmobile == "") {
                                                            gidmobile = "";
                                                        }
                                                        if (auxmobile == null || auxmobile == "") {
                                                            auxmobile = "";
                                                        }
                                                        if (gname == null || gname == "") {
                                                            gname = "";
                                                        }
                                                        if (gmid == null || gmid == "" || gmid.equals("0")) {
                                                            gmid = "";
                                                        }
                                                        if (amid == null || amid == "" || amid.equals("0")) {
                                                            amid = "";
                                                        }
                                                        if (wname == null || wname == "") {
                                                            wname = "";
                                                        }
                                                        if (tr_date_time == null || tr_date_time == "") {
                                                            tr_date_time = "";
                                                        }
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap><%=resultSet.getString("g_a_b")%></td>
                                                <td style="text-align: center;" nowrap><%=resultSet.getString("total_count")%></td>
                                                <td style="text-align: right; padding-right: 15px;" nowrap><%=resultSet.getString("total_amount")%></td>
                                                <td style="text-align: center;" nowrap><%=gmid%></td>
                                                <td nowrap><%=gname%></td>
                                                <td style="text-align: center;" nowrap><%=amid%></td>
                                                <td nowrap><%=wname%></td>
                                                <td style="text-align: right; padding-right: 15px;" nowrap><%=resultSet.getString("gamount")%></td>
                                                <td style="text-align: right; padding-right: 15px;" nowrap><%=resultSet.getString("wamount")%></td>
                                                <td nowrap><%=resultSet.getString("trno11")%></td>
                                                <td nowrap><%=resultSet.getString("payment_status")%></td>
                                                <td nowrap><%=tr_date_time%></td>
                                                <td style="text-align: right; padding-right: 15px;" nowrap><%=resultSet.getString("total_amount")%></td>
                                                <td nowrap><%=resultSet.getString("gidmobile")%></td> 
                                                <td nowrap><%=resultSet.getString("auxmobile")%></td>  
                                                <td nowrap><%=resultSet.getString("modified_on")%></td>
                                                <td nowrap><%=resultSet.getString("state_association")%></td>
