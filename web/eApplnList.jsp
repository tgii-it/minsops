                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; Digital Membership Forms
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select nvl(appln_mode,'NA') mode_of_application,nvl(gmobile,'0') gmobile,nvl(amobile,'0') amobile,nvl(icici_trdate,'NA') icici_trdate,nvl(icici_paymode,'NA') icici_paymode,nvl(trno,'NA') trno1,icici_refno icici_trno,nvl(trbank,'NA') trbank1,(case when formfilledby=trim('Member') then formfilledbygideonname when formfilledby=trim('Field Staff') then formfilledbyfoname else 'Prospective Member' end) form_filled_by,a.* from v_membership_eform_new a where a.status='Applied' order by rid desc";
