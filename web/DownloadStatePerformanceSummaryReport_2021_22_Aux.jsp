...
<%
    ...
    try {
        ...
        while (resultSet.next()) {
            filename = "SA-" + v_sa_no + "-Auxiliary Summary Report " + resultSet.getString("downloaded_on") + ".xls";
        }
        resultSet.close();
        stmt.close();
        conn.close();
            ...
            <div id="content">
                <div class="table-responsive" style="vertical-align: middle; height: 480px; background-color: #fff;">
                    <table id="summary" class="table table-bordered table-responsive table-hover" border="1">
                        ...
                        <thead style="background-color: #01354a; color: #ffe114;">   
                            <tr>
                                <th colspan="42" style="background-color: yellow; border-color: #fff; color: #01354a; text-align: left;"><h3><B>SA <%=v_sa_no%> - 2021-22 AUXILIARY PERFORMANCE REPORT - SUMMARY</B></h3></th>
                            </tr>  
                            <tr>
                                <th colspan="4" style="text-align: center; vertical-align: middle; font-weight: bold;  background-color: lightpink; border-color: #fff; color: #01354a;">&nbsp;</th>
