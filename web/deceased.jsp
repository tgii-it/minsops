...
<html>
    <head>
        ...
        <title>TGII | Deceased List</title>  
    ...
    <body class="container-fluid" style="background-color: #fff; width: 100%;" > 
        ...
        <section class="container-fluid" style="padding: 60px 0px; font-size: 11px;" >                
            <form name="frm2" id="frm2" method="post" action="deceased.jsp" >                      
                <div class='panel panel-default panel-accent-gold'>
                    ...
                    <div class="panel-heading" style="background-color: #fff;">
                        <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f;">
                            <i class="fa fa-fw fa-share"></i>&nbsp;<%= sa_no%>&nbsp; Deceased List (Real time)
                        </h3>
                    </div>
                        ...
                        <table id="comp_table" class="table table-bordered table-responsive table-hover" style="width:100%;">
                            <thead style="background-color: #01354a; color: #ffe114;">
                                <tr> 
                                    ...
                                    <th nowrap>Name</th> 
                                    <th nowrap>Member Status</th>
                                    <th nowrap>Deceased Date</th>
                                    <th nowrap>Member Type</th>
                                    ...
                                    <th nowrap>Source of Application</th>
                                    <th nowrap>State / Field Officer Name</th>
                                </tr>
                            </thead> 
                            <%
                            ...
                            %>
                            <tr>
                                <td nowrap><%=resultSet.getString("state_asso")%></td>                                  
                                <td nowrap><%=resultSet.getString("region")%></td>
                                <td nowrap><%=resultSet.getString("area")%></td>                                
                                ...
                                <td nowrap><%=life_start_date%>&nbsp; <%=annual_start_date%></td>
                                ...
                                <td nowrap><%=resultSet.getString("phone")%></td>
                                <td nowrap><%=resultSet.getString("mobile2")%></td>
                                <td nowrap><%=resultSet.getString("mobile3")%></td>
                                <td nowrap><%=resultSet.getString("email")%></td>
                                <td nowrap><%=resultSet.getString("designation")%></td>
                                <td nowrap><%=dob%></td> 
                                <td nowrap><%=resultSet.getString("church")%><%=resultSet.getString("caddress")%><%=resultSet.getString("cemail")%><%=resultSet.getString("cmobile")%></td>
                                <td nowrap><%=resultSet.getString("pastor_name")%><%=resultSet.getString("pastor_email")%><%=resultSet.getString("pastor_mobile")%><%=resultSet.getString("pastor_remarks")%></td>
                                <td nowrap><%=resultSet.getString("qualification")%></td>
                                <td nowrap><%=resultSet.getString("job_title")%></td>
                                <td nowrap><%=resultSet.getString("source_of_application")%></td>
                                <td nowrap><%=resultSet.getString("cred_nfr_res_per_state")%></td>
                            </tr>
                            <%
                                    }
                                    resultSet.close();
