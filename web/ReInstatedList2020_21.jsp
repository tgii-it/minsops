...
<%  String useraccessname = "";
    ...
    } else if (OBJ.equals("Mrs N Sandhana David") || OBJ.equals("Mr  R.Vijai Ram") || OBJ.equals("Anbalagan") || OBJ.equals("Mr Sam Varghese") || OBJ.equals("L C Raj Shekar")) {
...
<html>
    <head>
        ...
        <title>TGII | REINSTATED DASHBOARD</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" class="container-fluid" style="padding: 60px 0px;">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#gid_list" style="font-size: 12px; font-weight: bold;">Reinstated</a></li>
            </ul>
                    ...
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp; Reinstated List : PY 2020-21 
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="reinstated_tbl" style="float: left; width: 100%" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        ...
                                        <th style="text-align: center;" nowrap>END_DATE</th>   
                                        <th nowrap>SIGNUP_TYPE</th>    
                                        <th nowrap>CREDITED_TO</th>    
                                        <th nowrap>PROCESSED_ON</th>    
                                        <th nowrap>OLD_MID</th>        
        ...
        <script>
            $(document).ready(function () {
                var reinstated_tbl;
                reinstated_tbl = $('#reinstated_tbl').DataTable({
                    destroy: true,
                    responsive: true,
                    stateSave: true,
                    "ordering": true,
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1gre202021/gideonReInstatedJson202021/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "sa"},
