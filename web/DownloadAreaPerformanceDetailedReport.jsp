...
<%
    ...
    try {
        ...
        while (resultSet.next()) {
            filename = "SA-" + v_sa + " Area-" + v_area_region + " Detailed Report " + resultSet.getString("downloaded_on") + ".xls";
        }
        resultSet.close();
        stmt.close();
        conn.close();
                    ...
                    <table id="summary" class="table table-bordered table-responsive table-hover" border="1">
                        <thead style="background-color: #01354a; color: #ffe114;">   
                            ...
                            <tr>                                               
                                ...
                                <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Gideon<br>Opening<br>Balance<br>01 Jan 2024</th> 
                                ...
                                <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Auxiliary<br>Opening<br>Balance<br>01 Jan 2024</th> 
                        ...
                        <%
                            ...
                            try {
                                ...
                                sql = "select "
                                                ...
                                                + "a.* from STATE_Detailed_Report_20_21fa a where sa_no = nvl(trim(substr('" + v_sa + "',3,2)),'14') and region=nvl(trim(substr('" + v_area_region + "',3,1)),'0') and area=nvl(trim(substr('" + v_area_region + "',12,2)),'0') order by sa_no,region,area,camp";
