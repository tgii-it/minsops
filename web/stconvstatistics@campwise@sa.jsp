...
<html>
    <head>
        ...
        <title>State Conventions 2021 | Statistics</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <form name="frm2" id="frm2" method="post" action="stconvstatistics@campwise@sa.jsp" >  
                                                ...
                                                <select class="form-control" type="text" id="sa_no" name="sa_no" value="<%= sa_no%>" >
                                                    ...
                                                    <%
                                                        ...
                                                        if (sa_no.equalsIgnoreCase("SA1 (Tamil Nadu)")) {
                                                            sql = "select * from v_sa1sc2021_camp_wise_registrations_count1 order by camp";
                                                    %>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa2sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa3sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
