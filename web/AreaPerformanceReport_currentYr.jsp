...
<%
    ...
    String v_area_region = request.getParameter("area");
...
<html>
    <head>
        ...
        <title><%=v_sa%> &nbsp; Area <%=v_area_region%> Performance</title>
        ...
        <script type="text/javascript">
            ...
            function loadadblb() {
                ...
                xmlHttpRequest.open("POST", "Load_AreaDB_listox", true);
                xmlHttpRequest.send();
            }
        ...
        <script type="text/javascript">
            ...
            function getAreas(src) {
                ...
                if (item.value !== "-State Association-")
                {
                    var xmlHttpRequest = getXMLHttpRequest();
                    xmlHttpRequest.onreadystatechange = getReadyStateHandler(xmlHttpRequest);
                    xmlHttpRequest.open("POST", "LoadStateAssociationRegion?type=area&data=" + item.value, true);
                    xmlHttpRequest.send();
    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <form name="frm2" method="post" action="AreaPerformanceReport_currentYr.jsp" onsubmit="return FrontPage_Form1_Validator(this)">     
                        ...
                        <div class="form-row">                                       
                            <div class="form-group col-md-4">
                                <div class='input-group'>
                                    ...
                                    <select class="form-control" name="stateasso" id="stateasso" onchange="getAreas(this)">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="dropdown"><a href="#detailed_tab" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Download &nbsp; <span class="caret"></span></a>
                        <ul class="dropdown-menu dmenu">
                            <li><a href="DownloadAreaPerformanceDetailedReport.jsp?stateasso=<%=v_sa%>&area=<%=v_area_region%>&exportToExcel=YES">Detailed Report</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="tab-content">                    
                    <div id="detailed_tab" class="tab-pane active">
                            ...
                            <table id="detailed" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">   
                                    ...
                                    <tr>                                               
                                        ...
                                        <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance<br>as on<br>001 Jan 2024</th> 
                                        ...
                                        <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance<br>as on<br>001 Jan 2024</th> 
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        // a.* from E503_STATE_REPORT_TBL a where sa_no = nvl(trim(substr('" + v_sa + "',3,2)),'14') and region=nvl(trim(substr('" + v_area_region + "',3,1)),'0') and area=nvl(trim(substr('" + v_area_region + "',12,2)),'0') order by sa_no,region,area,camp";
                                        ...
                                        sql = "select "
                                                ...
                                                + "a.* from STATE_Detailed_Report_23_24fa a where sa_no = nvl(trim(substr('" + v_sa + "',3,2)),'14') and region=nvl(trim(substr('" + v_area_region + "',3,1)),'0') and area=nvl(trim(substr('" + v_area_region + "',12,2)),'0') order by sa_no,region,area,camp";
