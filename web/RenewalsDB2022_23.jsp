                    ...
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                ...
                                <i class="fa fa-fw fa-share"></i>&nbsp; 2022_23 RENEWALS DASHBOARD (INCLUDING DEFERRED PAYMENTS) 
                            </h3>
                        </div>
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sql = "select a.*,"
                                                    ...
                                                    + "from v_renewal_dashboard_dynamic_values_closed_13april2023 a order by to_number(sa_no) asc";
        ...
        <script>
            $(document).ready(function () {
                ...
                gideons = $('#gideons').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1gre2022_23/gideonRenewalsNew1Json202223/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "mid"},
        ...
        <script>
            $(document).ready(function () {
                ...
                auxiliary = $('#auxiliary').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1auxe2022_23/auxRenewalsNew1Json202223/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "mid"},
