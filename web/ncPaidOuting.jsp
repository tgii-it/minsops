...
<html>
    <head>
        ...
        <title>NC 2023 Paid Outing List</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 12px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; NC 2023 PAID OUTING LIST
                                    </h3>
                                </div>
                                <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                                    <table id="outing" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                <th style="text-align: center;" nowrap>Sl_No</th>
                                                <th style="text-align: center;" nowrap>Record_ID</th>
                                                <th nowrap>Delegate_Name</th>
                                                <th style="text-align: center;" nowrap>Contact_No</th>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String camp = "";
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "select rid,(case when gideonname is null then rwifename else gideonname end) name, "
                                                            + "(case when gideonname is null then auxmobile else gidmobile end) phone,"
                                                            + "outingcnt headcnt,status,camp,nvl(outingfee,'0') outingfee "
                                                            + "from nc2023 where bedastha='Yes' and nvl(outingfee,'0')>0 order by rid";
//                                                    System.out.println(query1);
                                            ...
                                            <tr>
                                                ...
                                                %> 
                                                <td style="text-align: center;" nowrap><%=sl_no%></td>
                                                <td style="text-align: center;" nowrap>&nbsp;<%= rid%></td>
                                                <td nowrap><%= name%></td>
                                                <td style="text-align: center;"><%= phone%></td>
                                                <td style="text-align: center;" nowrap><%= headcnt%></td>
                                        ...
                                        <tfoot>
                                            <tr style="background-color: yellow; font-weight: bold;">
                                                <th colspan="4" style="text-align: right; padding-right: 10px;">Page_Total<br>Overall_Total</th>
            ...
            $(document).ready(function () {
                var table = $('#outing').DataTable({
                    ...
                    buttons: [
                        ...
                        var pageTotal4 = api.column(4, {page: 'current'}).data().reduce(function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);
                        var pageTotal5 = api.column(5, {page: 'current'}).data().reduce(function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);

                        $(api.column(4).footer()).html('' + pageTotal4 + '<br>(' + total4 + ')');
                        $(api.column(5).footer()).html('' + pageTotal5 + '<br>(' + total5 + ')');
                    }
                });
            });
        </script>
