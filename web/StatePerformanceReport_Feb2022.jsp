                                        ...
                                        <table id="summary" class="table table-bordered table-responsive table-hover">
                                            <thead style="background-color: #01354a; color: #ffe114;">   
                                                ...
                                                <tr>                                               
                                                    ...
                                                    <th style="text-align: center; background-color: #ededff; border-color: #fff; color: #01354a;" nowrap>Friends</th>  
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    sql = "select no_of_camps,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo, "
                                                            ...
                                                            + "nvl((select friends from v_friends_dynamic_values_state_perf_report where sa_no=a.sa_no and region=a.region and area=a.area and rownum<2),'0') friends,"
                                        ...
                                        <table id="detailed" class="table table-bordered table-responsive table-hover">
                                            <thead style="background-color: #01354a; color: #ffe114;">   
                                                ...
                                                <tr>                                               
                                                    ...
                                                    <th style="background-color: #ededff; border-color: #fff; color: #01354a;" nowrap>Friends</th>  
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    stmt = conn.createStatement();
                                                    sql = "select friends,"
                                                           // + "nvl((select friends from v_friends_dynamic_values_state_perf_report where sa_no=a.sa_no and region=a.region and area=a.area and upper(camp)=upper(a.camp)),'0') friends,"
                                                            + "(select status from camps_master where upper(camp)=upper(a.camp)) camp_status,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                            ...
                                                            + "a.* from STATE_Detailed_Report_21_22fa_testing a where sa_no='" + v_sa_no + "' and decode(a.region,'SA_Total','94','Inactive Camps','95','PWT SF','96','SA_Suspense','97','Total','98',a.region)>0 "
                                                            + "order by sa_no,region,area,camp";
                                            ...
                                            <tr style="background-color: #F0FFFF; font-weight: bold; font-size: 11px; color: navy;">
                                                ...
                                                <td colspan="3" style="text-align: right;" nowrap>Region-<%=resultSet.getString("region")%> Total&nbsp; </td>
                                                <%
                                                } else if (display_camp.equalsIgnoreCase("z_Total")) {
                                                %>
