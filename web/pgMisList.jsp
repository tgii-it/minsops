                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f;">
                                        ...
                                        <a type='button' class="pull-right" href="pgMisBatchProcessed.jsp" title='Show Pending Records'><i class='fa fa-comments-o' aria-hidden='true'>&nbsp; <b>Show Processed</b></i></a>
                                    </h3>
                                </div>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "select (select state_asso from camps_master where upper(camp) = upper(a.camp)) state_association,camp,name,mid,head_count memplan,reg_fee,status memstatus,mobile phone,trstatus,trpaymode,ICICI_Paid_Amount tramount,trno,trpaydate,'' record_status,sysdate submitted_on,'' contactPerson,'' remarks,'' tally_receipt_no,'' processed_by from pgmis_conventions a where batch_date is null order by state_asso,camp";
                                                    ...
                                                    while (rs1.next()) {
                                                        ...
                                                        payment_updated_by = rs1.getString("processed_by");
                                ...
                                <div class="panel-body" style="padding-top: 20px; width: 100%"> 
                                    <div class="form-group col-lg-12">                   
                                        ...
                                        <div class="form-group col-lg-3">
                                            <label for="paymentdate">Batch Process Date</label>
                                        ...
                                        <div class="form-group col-lg-4" hidden>
                                            ...
                                            <div class='input-group'>
                                                ...
                                                <input type="hidden" class="form-control" name="requestType" id="requestType" value="AccountsMercy">  
                                            </div>
                                        </div>      
