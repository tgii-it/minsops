                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f;">
                                        ...
                                        <a type='button' class="pull-right" href="DispatchMis_processed.jsp" title='Show Processed Records'><i class='fa fa-comments-o' aria-hidden='true'>&nbsp; <b>Show Processed</b></i></a>
                                    </h3>
                                </div>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    query1 = "Select * from membership_weekly_raw where status = 'Current' and record_status in ('Card Printed') order by camp,mid";
