                                        ...
                                        <table id="summary" class="table table-bordered table-responsive table-hover">
                                            ...
                                            <%
                                                ...
                                                try {
                                                    conn = ds.getConnection();
                                                    stmt = conn.createStatement();
                                                    String sql = "select no_of_camps,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo, "
                                                            ...
                                                            + "a.* from STATE_SUMMARY_REPORT_C_2021_22_09June2022_final_2021_22  a where sa_no='" + v_sa_no + "' and decode(region,'SA_Total','94','Inactive Camps','95','PWT SF','96','SA_Suspense','97','Total','98',region)>0 order by sa_no,region,area";
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    sql = "select (select status from camps_master where upper(camp)=upper(a.camp)) camp_status,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                            ...
                                                            + "a.* from STATE_Detailed_Report_21_22fa_09June2022_final_2021_22 a where sa_no='" + v_sa_no + "' and decode(a.region,'SA_Total','94','Inactive Camps','95','PWT SF','96','SA_Suspense','97','Total','98',a.region)>0 order by sa_no,a.region,area,camp";
                                        ...
                                        <table id="inactive" class="table table-bordered table-responsive table-hover">
                                            <thead style="background-color: #01354a; color: #ffe114;">   
                                                ...
                                                <tr>                                               
                                                    ...
                                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Gideon<br>Opening<br>Balance as on<br>31 May 2022</th> 
                                                    ...
                                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Auxiliary<br>Opening<br>Balance as on<br>31 May 2022</th> 
