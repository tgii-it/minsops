...
<html>
    <head>
        ...
        <title>State Conventions 2022 | Statistics</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <form name="frm2" id="frm2" method="post" action="stconvstatistics@campwise@sa2022.jsp" >  
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                                ...
                                                <select class="form-control" type="text" id="sa_no" name="sa_no" value="<%= sa_no%>" >
                                                    ...
                                                    <%
                                                        ...
                                                        if (sa_no.equalsIgnoreCase("SA1 (Tamil Nadu)")) {
                                                            sql = "select * from V_SA1SC2022_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_sa2sC2022_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %> 
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_sa3sC2022_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa4sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa5sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa6sc2021_camp_wise_registrations_count1 order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa7sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa8sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa9sc2021_camp_wise_registrations_count1 order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa10sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa11sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa12sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa13sc2021_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                ...
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp;<%=sa_no%> -:- State Convention Registrations (Real-time data)
                                    </h3>
                                </div>
