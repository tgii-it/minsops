...
<html>
    <head>
        ...
        <title>National Conventions 2021 | Report</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <form name="frm2" id="frm2" method="post" action="ncstatstateandcampwise.jsp" >  
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                    ...
                                    <div class="form-row"> 
                                                ...
                                                <select class="form-control" type="text" id="sa_no" name="sa_no" value="<%= sa_no%>" >
                                                    ...
                                                    <%
                                                        ...
                                                        if (sa_no.equalsIgnoreCase("SA1 (Tamil Nadu)")) {
                                                            sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='1' order by camp";
                                                    %>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='2' order by camp";
                                                    %> 
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='3' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='4' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='5' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='6' order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='7' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                    } else if (sa_no.equalsIgnoreCase("SA8 (Rajasthan Delhi Punjab and Haryana)")) {
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='8' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <option value="SA6 (Madhya Pradesh and Chattisgarh)">SA6 (Madhya Pradesh and Chattisgarh)</option> 
                                                    <option value="SA7 (Maharashtra and Gujarat)">SA7 (Maharashtra and Gujarat)</option> 
                                                    <option value="SA8 (Rajasthan Delhi Punjab and Haryana)" selected>SA8 (Rajasthan Delhi Punjab and Haryana)</option> 
                                                    <option value="SA9 (Uttar Pradesh and Uttarakhand)">SA9 (Uttar Pradesh and Uttarakhand)</option> 
                                                    <option value="SA10 (Bihar and Jharkhand)">SA10 (Bihar and Jharkhand)</option> 
                                                    <option value="SA11 (Orissa West Bengal and Sikkim)">SA11 (Orissa West Bengal and Sikkim)</option> 
                                                    <option value="SA12 (Mizoram Tripura Meghalaya and Lower Assam)">SA12 (Mizoram Tripura Meghalaya and Lower Assam)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='9' order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                    } else if (sa_no.equalsIgnoreCase("SA10 (Bihar and Jharkhand)")) {
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='10' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <option value="SA8 (Rajasthan Delhi Punjab and Haryana)">SA8 (Rajasthan Delhi Punjab and Haryana)</option> 
                                                    <option value="SA9 (Uttar Pradesh and Uttarakhand)">SA9 (Uttar Pradesh and Uttarakhand)</option> 
                                                    <option value="SA10 (Bihar and Jharkhand)" selected>SA10 (Bihar and Jharkhand)</option> 
                                                    <option value="SA11 (Orissa West Bengal and Sikkim)">SA11 (Orissa West Bengal and Sikkim)</option> 
                                                    <option value="SA12 (Mizoram Tripura Meghalaya and Lower Assam)">SA12 (Mizoram Tripura Meghalaya and Lower Assam)</option>
                                                    <option value="SA13 (Arunachal Pradesh Nagaland Manipur and Upper Assam)">SA13 (Arunachal Pradesh Nagaland Manipur and Upper Assam)</option>
                                                    <option value="Show All">Show All</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='11' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                    } else if (sa_no.equalsIgnoreCase("SA12 (Mizoram Tripura and Meghalaya)")) {
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='12' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <option value="SA10 (Bihar and Jharkhand)">SA10 (Bihar and Jharkhand)</option> 
                                                    <option value="SA11 (Orissa West Bengal and Sikkim)">SA11 (Orissa West Bengal and Sikkim)</option> 
                                                    <option value="SA12 (Mizoram Tripura and Meghalaya)" selected>SA12 (Mizoram Tripura and Meghalaya)</option>
                                                    <option value="SA13 (Arunachal Pradesh Nagaland Manipur and Upper Assam)">SA13 (Arunachal Pradesh Nagaland Manipur and Upper Assam)</option>
                                                    <option value="Show All">Show All</option>

                                                    <%
                                                    } else if (sa_no.equalsIgnoreCase("SA13 (Arunachal Pradesh Nagaland and Manipur)")) {
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='13' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <option value="SA11 (Orissa West Bengal and Sikkim)">SA11 (Orissa West Bengal and Sikkim)</option> 
                                                    <option value="SA12 (Mizoram Tripura Meghalaya and Lower Assam)">SA12 (Mizoram Tripura Meghalaya and Lower Assam)</option>
                                                    <option value="SA13 (Arunachal Pradesh Nagaland and Manipur)" selected>SA13 (Arunachal Pradesh Nagaland and Manipur)</option>
                                                    <option value="Show All">Show All</option>
                                                    <option value="Show All">Show All</option>

                                                    <%
                                                    } else if (sa_no.equalsIgnoreCase("Show All")) {
                                                        sql = "select * from V_NC2021_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                        ...
                                        <div class="form-group col-md-3">
                                            <div class='input-group'>
                                                <input type="submit" class="btn btn-primary submit-btn" id="submit-btn" value="Get details">
                                            </div>                                            
                                        </div>                                            
                                    </div>
                                </div>   
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp;National Convention -:- <%=sa_no%> Registrations
                                    </h3>
                                </div>
                                <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; color: black; height: auto;">
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                <th colspan="5" style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center;">CAMP STRENGTH &AMP; REGISTRATIONS</th>
                                                <th colspan="3" style="background-color: #F0FFFF; border-color: #fff; color: #01354a; text-align: center;">GIDEONS STRENGTH &AMP; REGISTRATIONS</th>
                                                <th colspan="3" style="background-color: #ffe8e7; border-color: #fff; color: #01354a; text-align: center;">AUXILIARY STRENGTH &AMP; REGISTRATIONS</th>
                                                <th style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center;"></th>
                                            </tr>
                                            <tr>
                                                <th nowrap>Region Area</th>
                                                <th nowrap>Camp Name</th>
                                                <th style="text-align: center;" nowrap>Total Strength</th>
                                                <th style="text-align: center;" nowrap>Total Registered</th>
                                                <th style="text-align: center;" nowrap>Percentage</th>
                                                <th style="text-align: center;" nowrap>Gideons Strength</th>  
                                                <th style="text-align: center;" nowrap>Gideons Registered</th>
                                                <th style="text-align: center;" nowrap>Gideons Percentage</th>
                                                <th style="text-align: center;" nowrap>Auxiliary Strength</th>
                                                <th style="text-align: center;" nowrap>Auxiliary Registered</th>
                                                <th style="text-align: center;" nowrap>Auxiliary Percentage</th>  
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    while (resultSet.next()) {
                                                        sa = resultSet.getString("camp");
                                                        r_a = resultSet.getString("r_a");
                                                        state_association = resultSet.getString("total_strength");
                                                        gideons_pending = resultSet.getString("total_registered");
                                                        auxiliary_pending = resultSet.getString("total_per");
                                                        couple_pending = resultSet.getString("gid_strength");
                                                        total_pending = resultSet.getString("gideon_registered");
                                                        gideons_processed = resultSet.getString("gid_per");
                                                        auxiliary_processed = resultSet.getString("aux_strength");
                                                        couple_processed = resultSet.getString("aux_registered");
                                                        total_processed = resultSet.getString("aux_per");
                                                        state_asso = resultSet.getString("state_asso");

                                                        if (auxiliary_pending == null) {
                                                            auxiliary_pending = "0%";
                                                        }
                                                        if (gideons_processed == null) {
                                                            gideons_processed = "0%";
                                                        }
                                                        if (total_processed == null) {
                                                            total_processed = "0%";
                                                        }
                                                        if (state_asso == null) {
                                                            state_asso = "0%";
                                            ...
                                            %>
                                            <tr>
                                                <td style="font-weight: bold; color:#01354a; text-align: center;" nowrap><%=r_a%></td>
                                                <td style="font-weight: bold; color:#01354a;" nowrap><%=sa%></td>
                                                <td style="background-color: #F2FAD8; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=state_association%></td>
                                                <td style="background-color: #F2FAD8; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=gideons_pending%></td>
                                                <td style="background-color: #F2FAD8; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=auxiliary_pending%></td>
                                                <td style="background-color: #F0FFFF; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=couple_pending%></td>
                                                <td style="background-color: #F0FFFF; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=total_pending%></td>
                                                <td style="background-color: #F0FFFF; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=gideons_processed%></td>
                                                <td style="background-color: #ffe8e7; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=auxiliary_processed%></td>
                                                <td style="background-color: #ffe8e7; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=couple_processed%></td>
                                                <td style="background-color: #ffe8e7; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=total_processed%></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="2" style="background-color: #F2FAD8; color: #01354a; font-weight: bold; text-align: right;">Total</th>
                                                <th style="background-color: #F2FAD8; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #F2FAD8; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #F2FAD8; color: #01354a; font-weight: bold; text-align: center;"></th>

                                                <th style="background-color: #F0FFFF; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #F0FFFF; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #F0FFFF; color: #01354a; font-weight: bold; text-align: center;"></th>

                                                <th style="background-color: #ffe8e7; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #ffe8e7; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #ffe8e7; color: #01354a; font-weight: bold; text-align: center;"></th>
                                                <th style="background-color: #ffe8e7; color: #01354a; font-weight: bold; text-align: center;"></th>
                                            </tr>
