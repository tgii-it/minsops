...
<html>
    <head>
        ...
        <title>TGII | Digital Applications</title>
    ...
    <body style="background-color: #fff; width: 100%;">
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="myNavbar" style="background-color: #01354a;">
                    <ul class="nav navbar-nav navbar-left">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #ffe114; font-size: 12px; font-weight: bold;">Digital Membership Forms &nbsp;
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu dmenu">
                                <li><a href="eApplnList.jsp"><i class="fa fa-list" aria-hidden="true"></i> &nbsp; Fresh Applications</a></li>
                                <li class="divider"></li>
                                <li><a href="eApplnCommitteeApprovalList.jsp"><i class="fa fa-list" aria-hidden="true"></i> &nbsp; Forwarded for Committee Approval</a></li>
                                <li><a href="eApplnCommitteeApprovedList.jsp"><i class="fa fa-list" aria-hidden="true"></i> &nbsp; Apporved Applications</a></li>
                                <li class="divider"></li>
                                <li active><a href="eApplnMovedtoMembershipMaster.jsp"><i class="fa fa-fw fa-list" aria-hidden="true"></i> &nbsp; Applications Moved to Membership Master</a></li>
                                <li class="divider"></li>
                                <li><a href="eApplnMovetoTrash.jsp"><i class="fa fa-fw fa-share" aria-hidden="true"></i> &nbsp; Move to Trash floder</a></li>
                                <li><a href="eApplnRestorefromTrash.jsp"><i class="fa fa-fw fa-share" aria-hidden="true"></i> &nbsp; Restore from Trash folder</a></li>
                                <li class="divider"></li>
                                <li active><a href="applyonlineNew.jsp"><i class="fa fa-fw fa-edit" aria-hidden="true"></i> &nbsp; Submit New Application</a></li>
                            </ul>
                        </li>
                    </ul> 
        ...
        <section id="main" style="padding: 60px 0px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form name="frm_apply" method="post" action="NewApplnMovetoTrash" onsubmit="return validateCheckbox(this)">
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; Membership Application Forms
                                        <i class='fa fa-comments-o pull-right' aria-hidden='true'>&nbsp; <b>Move to Trash Folder</b></i>&nbsp; &nbsp; &nbsp;
                                    </h3>
                                </div>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select nvl(mode_of_application,'NA') mode_of_application,nvl(gmobile,'0') gmobile,nvl(amobile,'0') amobile,nvl(icici_trdate,'NA') icici_trdate,nvl(icici_paymode,'NA') icici_paymode,nvl(trno1,'NA') trno1,nvl(icici_trno,'NA') icici_trno,nvl(trbank1,'NA') trbank1,a.* from v_membership_eform_new a where status!='Current' order by rid desc";
                                                    ResultSet rs = statement.executeQuery(sql);
                                                    while (rs.next()) {
                                                        mplan = rs.getString("mplan");
                                                        paymethod = rs.getString("paymethod");
                                                        if (paymethod.equalsIgnoreCase("Payment Gateway")) {
                                                            trno = rs.getString("icici_trno");
                                                            trdate = rs.getString("icici_trdate");
                                                            trbank = rs.getString("icici_paymode");
                                                        } else {
                                                            trno = rs.getString("trno1");
                                                            trdate = rs.getString("trdate1");
                                                            trbank = rs.getString("trbank1");
                                                        }
                                            %>
                                            <tr>
                                                <td style='text-align: center;' nowrap>&nbsp;&nbsp;<input type="checkbox" name="chkApprove" id="chkApprove" value="<%= rs.getString("rid")%>" />&nbsp;&nbsp;&nbsp; <%= rs.getString("rid")%> &nbsp;&nbsp;&nbsp;</td>
                                                    <%
                                                        if (mplan.contains("Annual Gideon")) {
                                                    %>
                                                <td nowrap><a href='https://pg.gideons.org.in/PrintewpApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:blue'></i></a>&nbsp;&nbsp;&nbsp;<i class='glyphicon glyphicon-edit' style='padding-left:5px; font-size:16px;'></i></td>
                                                        <%
                                                        } else if (mplan.contains("Annual Auxiliary")) {
                                                        %>
                                                <td nowrap><a href='https://pg.gideons.org.in/PrintewpApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:red'></i></a>&nbsp;&nbsp;&nbsp;<i class='glyphicon glyphicon-edit' style='padding-left:5px; font-size:16px;'></i></td>
                                                        <%
                                                        } else if (mplan.contains("Annual Both")) {
                                                        %>
                                                <td nowrap><a href='https://pg.gideons.org.in/PrintewpApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:blue'></i></a>&nbsp;&nbsp;&nbsp;<a href='https://pg.gideons.org.in/PrintewpApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:red'></i></a>&nbsp;&nbsp;<i class='glyphicon glyphicon-edit' style='padding-left:5px; font-size:16px;'></i></td>
                                                        <%
                                                        } else if (mplan.contains("Life Gideon")) {
                                                        %>
                                                <td nowrap><a href='https://pg.gideons.org.in/PrinteApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:blue'></i></a>&nbsp;&nbsp;&nbsp;<i class='glyphicon glyphicon-edit' style='padding-left:5px; font-size:16px;'></i></td>
                                                        <%
                                                        } else if (mplan.contains("Life Auxiliary")) {
                                                        %>
                                                <td nowrap><a href='https://pg.gideons.org.in/PrinteApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:red'></i></a>&nbsp;&nbsp;&nbsp;<i class='glyphicon glyphicon-edit' style='padding-left:5px; font-size:16px;'></i></td>
                                                        <%
                                                        } else if (mplan.contains("Life Both")) {
                                                        %>
                                                <td nowrap><a href='https://pg.gideons.org.in/PrinteApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:blue'></i></a>&nbsp;&nbsp;&nbsp;<a href='https://pg.gideons.org.in/PrinteApplication?refno=<%=rs.getString("rid")%>' target='_blank'><i class='fa fa-file-pdf-o' style='font-size:16px; color:red'></i></a>&nbsp;&nbsp;<i class='glyphicon glyphicon-edit' style='padding-left:5px; font-size:16px;'></i></td>
                                                        <%
                                                            }
                                                        %>
                                                <td nowrap><%=rs.getString("mode_of_application")%></td>
                                                ...
                                                <td nowrap><%=rs.getString("formfilledby1")%></td>
                            ...
                            <div class="form-group col-md-12">
                                <div class='input-group pull-right'>
                                    <input type="submit" class="btn btn-primary" id="final-submit" value="Move to Trash Folder">
                                </div>                                            
                            </div>
                        </form>
                    </div> 
