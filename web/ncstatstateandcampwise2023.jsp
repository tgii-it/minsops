...
<html>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <form name="frm2" id="frm2" method="post" action="ncstatstateandcampwise2023.jsp" >  
                                                ...
                                                <select class="form-control" type="text" id="sa_no" name="sa_no" value="<%= sa_no%>" >
                                                    ...
                                                    <%
                                                        ...
                                                        if (sa_no.equalsIgnoreCase("SA1 (Tamil Nadu)")) {
                                                            sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='1' order by camp";
                                                    %>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='2' order by camp";
                                                    %> 
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='3' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='4' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='5' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='6' order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='7' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='8' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='9' order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='14' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='11' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='12' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 where sa_no='13' order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_NC2023_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                ...
                                <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; color: black; height: auto;">
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            ...
                                            %>
                                            <tr>
                                                <td style="font-weight: bold; color:#01354a; text-align: center;" nowrap><%=region%></td>
                                                <td style="font-weight: bold; color:#01354a; text-align: center;" nowrap><%=area%></td>
                                                ...
                                                <td style="background-color: #F2FAD8; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=tr%></td>
                                                ...
                                                <td style="background-color: #F0FFFF; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=gr%></td>
                                                ...
                                                <td style="background-color: #ffe8e7; border-color: #ddd; color: #01354a; text-align: center; font-weight: bold;" nowrap><%=ar%></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="3" style="background-color: #F2FAD8; color: #01354a; font-weight: bold; text-align: right;">Total</th>
