...
<html>
    <head>
        ...
        <title>SA1SC 2021 | Pending Registrations</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp;All St Conv Registrations (WhatsApp Grouping)
                                    </h3>
                                </div>
                                <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; color: black; height: auto;">
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                <th><a href="javascript:selectToggle(true, 'frm_apply');" style="color: #fff;"><b>Select All</b></a> | <a href="javascript:selectToggle(false, 'frm_apply');" style="color: #fff;"><b>None</b></a></th>
                                                ...
                                                <!--<th nowrap>WA_Status</th>
                                                <th nowrap>WA_Remarks</th>
                                                <th nowrap>WA_Processed_on</th>
                                                <th nowrap>WA_Processed_by</th>-->
                                            </tr>
                                        </thead>
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String gid = "";
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select * from V_STATE_CONVENTIONS_2021_4_WHATSAPP_GROUP order by state_association,region,area,camp,rid";
                                                    ...
                                                    while (resultSet.next()) {
                                                        ...
                                                        //  wa_status = resultSet.getString("wa_status");
                                                        //  wa_remarks = resultSet.getString("wa_remarks");
                                                        //  wa_processed_on = resultSet.getString("wa_processed_on");
                                                        //   wa_processed_by = resultSet.getString("wa_processed_by");
                                                        ...
                                                        if (amobile == "0" || amobile.equalsIgnoreCase("0")) {
                                                            amobile = "";
                                                        }
                                                        ...
                                                        if (wa_processed_on == null) {
                                                            wa_processed_on = "--";
                                                        }
                                                        if (wa_processed_by == null) {
                                                            wa_processed_by = "--";
                                                        }

                                                        if (wa_status.equalsIgnoreCase("Processed")) {
                                            %>
                                            <tr style="background-color: #B7FFBF; color: navy;">
                                                <td nowrap>&nbsp;</td>
                                                <td nowrap><%=rid%></td>
                                                ...
                                                <!--<td nowrap><%=wa_status%></td>
                                                <td nowrap><%=wa_remarks%></td>
                                                <td nowrap><%=wa_processed_on%></td>
                                                <td nowrap><%=wa_processed_by%></td>-->
                                                <%
                                                } else {
                                                %>
                                            <tr>
                                                <td nowrap><center><input type="checkbox" name="chkApprove" id="chkApprove" value="<%= rid%>" /></center></td>
                                        <td nowrap><%=rid%></td>
                                        <td nowrap><%=resultSet.getString("camp")%></td>
                                        <td nowrap><%=resultSet.getString("status")%></td>
                                        <td nowrap><%=g_a_b%></td>
