                ...
                <div class="table-responsive" style="vertical-align: middle; height: 480px; background-color: #fff;">
                    <table id="summary" class="table table-bordered table-responsive table-hover" border="1">
                        <thead style="background-color: #01354a; color: #ffe114;">   
                            <tr>
                                <th colspan="79" style="background-color: yellow; border-color: #fff; color: #01354a; text-align: left;"><h3><B>CAMP WISE : 2020-21 PERFORMANCE REPORT - DETAILED</B></h3></th>
                            </tr>   
                            <tr>
                                ...
                                <th colspan="4"  style="text-align: center; vertical-align: middle; font-weight: bold; background-color: #ffffd4; border-color: #fff; color: #01354a;">Gideon New Memberships</th>
                                ...
                                <th colspan="4"  style="text-align: center; vertical-align: middle; font-weight: bold; background-color: #ffe9ec; border-color: #fff; color: #01354a;">Auxiliary New Memberships</th>
                            ...
                            <tr>                                               
                                <th style="text-align: center; background-color: #ededff; border-color: #fff; color: #01354a;" nowrap>State Association</th>
                        ...
                        <tr style="background-color: #01354a; font-weight: bold; color: rgb(255, 225, 20);;">
                            <td colspan="4" style="text-align: right;"><%=display_sa%> Total&nbsp; </td>
                            <%
                        ...
                        <tr style="background-color: #fff6f6; font-weight: bold; color: navy;">
                            ...
                            <td colspan="3" style="text-align: right;" nowrap><%=resultSet.getString("region")%> Total&nbsp; </td>
                            <%
