                        ...
                        <div class='panel panel-default panel-accent-gold'>
                            <div class="panel-heading" style="background-color: #fff;">
                                <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                    <i class="fa fa-fw fa-share"></i>&nbsp;State Convention Registrations : Complete Report
                                </h3>
                            </div>
                                ...
                                <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                    <thead style="background-color: #01354a; color: #ffe114;">
                                        <tr>
                                            ...
                                            <th colspan="4" style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center;">OVERALL</th>
                                            <th colspan="3" style="background-color: #ededff; border-color: #fff; color: #01354a; text-align: center;">GIDEONS</th>
                                            <th colspan="3" style="background-color: pink; border-color: #fff; color: #01354a; text-align: center;">AUXILIARY</th>
                                        </tr>
                                        <tr>
                                            <th hidden nowrap>Sl_No</th>
                                            <th nowrap>State Association</th>
                                            <th style="text-align: center;" nowrap>Active_Camps</th>
                                            <th style="text-align: center;" nowrap>Strength</th>
                                            <th style="text-align: center;" nowrap>Registered</th>
                                            <th style="text-align: center;" nowrap>Yet_to_Reg</th>
                                    ...
                                    <tbody id='mytab' class="table-search"> 
                                        <%
                                            ...
                                            String total_registered = "";
                                            String total_not_registered = "";
                                            String gideons_strength = "";
                                            String gideons_registered = "";
                                            String gideons_not_registered = "";
                                            String aux_strength = "";
                                            String aux_registered = "";
                                            String aux_not_registered = "";
                                            ...
                                            try {
                                                ...
                                                String sql = "select * from V_STATE_CONVENTIONS_REPORT_FOR_ED order by sa_no";
                                                ResultSet resultSet = statement.executeQuery(sql);
                                                while (resultSet.next()) {
                                                    sa = resultSet.getString("SA_NO");
                                                    state_association = resultSet.getString("STATE_ASSO");
                                                    no_of_camps = resultSet.getString("NO_OF_CAMPS");
                                                    total_strength = resultSet.getString("TOTAL_STRENGTH");
                                                    total_registered = resultSet.getString("TOTAL_REGISTERED");
                                                    total_not_registered = resultSet.getString("TOTAL_NOT_REGISTERED");
                                                    gideons_strength = resultSet.getString("GIDEONS_STRENGTH");
                                                    gideons_registered = resultSet.getString("GIDEON_REGISTERED");
                                                    gideons_not_registered = resultSet.getString("GIDEON_NOT_REGISTERED");
                                                    aux_strength = resultSet.getString("AUX_STRENGTH");
                                                    aux_registered = resultSet.getString("AUX_REGISTERED");
                                                    aux_not_registered = resultSet.getString("AUX_NOT_REGISTERED");
                                        %>
                                        <tr>
                                            <td hidden nowrap><%=sa%></td>
                                            <td nowrap><%=state_association%></td>
                                            <td style="text-align: center;" nowrap><%=no_of_camps%></td>
                                            <td style="text-align: center;" nowrap><%=total_strength%></td>
                                            <td style="background-color: #F2FAD8; border-color: #fff; color: #01354a; text-align: center; font-weight: bold;" style="text-align: center;" nowrap><%=total_registered%></td>
                                            <td style="text-align: center;" nowrap><%=total_not_registered%></td>
                                            <td style="text-align: center;" nowrap><%=gideons_strength%></td>
                                            <td style="background-color: #ededff; border-color: #fff; color: #01354a; text-align: center; font-weight: bold;" style="text-align: center;" nowrap><%=gideons_registered%></td>
                                            <td style="text-align: center;" nowrap><%=gideons_not_registered%></td>
                                            <td style="text-align: center;" nowrap><%=aux_strength%></td>
                                            <td style="background-color: pink; text-align: center; font-weight: bold;" nowrap><%=aux_registered%></td>
                                            <td style="text-align: center;" nowrap><%=aux_not_registered%></td>
                                            <%
                                                    }
                                                    con.close();
                                                } catch (Exception e) {
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style="background-color: #ededff; color: #01354a; font-weight: bold; text-align: center;"></th>
                                            <th style="background-color: #ededff; color: #01354a; font-weight: bold; text-align: center;"></th>
                                            <th style="background-color: pink; color: #01354a; font-weight: bold; text-align: center;"></th>
                                            <th style="background-color: pink;  color: #01354a; font-weight: bold; text-align: center;"></th>
                                            <th style="background-color: pink;    color: #01354a; font-weight: bold; text-align: center;"></th>
                                        </tr>
                                    </tfoot>
