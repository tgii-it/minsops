    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form name="frm_apply" method="post" action="NewApplnMovetoMasterTable" onsubmit="return validateCheckbox(this)">
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; List of Approved Digital Forms
                                        <i class='fa fa-comments-o pull-right' aria-hidden='true'>&nbsp; <b>Step 3 : Move to Membership Master</b></i>&nbsp; &nbsp; &nbsp;
                                    </h3>
                                </div>
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String sql = "select nvl(mode_of_application,'NA') mode_of_application,nvl(gmobile,'0') gmobile,nvl(amobile,'0') amobile,nvl(icici_trdate,'NA') icici_trdate,nvl(icici_paymode,'NA') icici_paymode,nvl(trno1,'NA') trno1,nvl(icici_trno,'NA') icici_trno,nvl(trbank1,'NA') trbank1,a.* from v_membership_eform_new a where status='Approved' order by rid desc";
                            ...
                            <div class="form-group col-md-12">
                                <div class='input-group pull-right'>
                                    <input type="submit" class="btn btn-primary" id="final-submit" value="Step 3 : Move to Membership Master">
                                </div>                                            
                            </div>
                        </form>
                    </div> 
