...
<html>
    <head>
        ...
        <title>State Conventions 2023 | Statistics</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <form name="frm2" id="frm2" method="post" action="stconvstatistics@campwise@sa2023.jsp" >  
                                                ...
                                                <select class="form-control" type="text" id="sa_no" name="sa_no" value="<%= sa_no%>" >
                                                    ...
                                                    <%
                                                        ...
                                                        if (sa_no.equalsIgnoreCase("SA1 (Tamil Nadu)")) {
                                                            sql = "select * from V_SA1SC2023_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_sa2sC2023_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %> 
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from V_sa3sC2023_CAMP_WISE_REGISTRATIONS_COUNT1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa4sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa5sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa6sc2023_camp_wise_registrations_count1 order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa7sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa8sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa9sc2023_camp_wise_registrations_count1 order by camp";
                                                    %>
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa10sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa11sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa12sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
                                                    ...
                                                    <%
                                                        ...
                                                        sql = "select * from v_sa13sc2023_camp_wise_registrations_count1 order by camp";
                                                    %> 
                                                    <option value="SA1 (Tamil Nadu)">SA1 (Tamil Nadu)</option>
                                                    <option value="SA2 (Kerala)">SA2 (Kerala)</option>
                                                    <option value="SA3 (Karnataka and Goa)">SA3 (Karnataka and Goa)</option>
