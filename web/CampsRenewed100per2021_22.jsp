...
<html>
    <head>
        ...
        <title>2021_22 Camps Renewed 100% | List</title>
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 12px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; 2021_22 CAMPS RENEWED 100% : LIST
                                    </h3>
                                </div>
                                    ...
                                    <table id="gideon" class="table table-bordered table-responsive table-hover" style="width: 100%;">
                                        <thead style="background-color: #01354a; color: #ffe114;">
                                            <tr>
                                                ...
                                                <th style="text-align: center;" nowrap>Gid_Op_Bal</th>
                                                <th style="text-align: center;" nowrap>Gid_Renewed</th>
                                                <th style="text-align: center;" nowrap>Aux_Op_Bal</th>
                                                <th style="text-align: center;" nowrap>Aux_Renewed</th>
                                            </tr>
                                        </thead>
                                        <tbody id='mytab' class="table-search"> 
                                            <%  String camp = "";
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "select 'SA '||sa_no SA,sa_no,'Region-'||region region,'R-'||region||'/Area-'||area area,camp,(select status from camps_master where upper(camp)=upper(a.camp)) camp_status,memberships_gid_op_bal gid_op_bal,gideon_renewed,memberships_aux_op_bal aux_op_bal,aux_renewed  "
                                                            + "from state_detailed_report_2021_22_09June2022_final_2021_22 a where memberships_gid_op_bal>0 and memberships_aux_op_bal>0 and gideon_renewed=memberships_gid_op_bal and aux_renewed=memberships_aux_op_bal "
                                                            + "order by to_number(sa_no),region,area,camp";
                                                    ...
                                                    while (rs1.next()) {
                                                        ...
                                                        status = rs1.getString("camp_status");
                                                        gid_op_bal = rs1.getString("gid_op_bal");
                                                        gid_renewed = rs1.getString("gideon_renewed");
                                                        aux_op_bal = rs1.getString("aux_op_bal");
                                                        aux_renewed = rs1.getString("aux_renewed");
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap><%= camp%></td>
                                                <td nowrap><%= status%></td>
                                                <td style="text-align: center;"><%= gid_op_bal%></td> 
                                                <td style="text-align: center;"><%= gid_renewed%></td> 
                                                <td style="text-align: center;"><%= aux_op_bal%></td> 
                                                <td style="text-align: center;"><%= aux_renewed%></td> 
                                                <%
                                                        }
                                                        st1.close();
                                                        rs1.close();
