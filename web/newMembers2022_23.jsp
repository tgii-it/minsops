                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                <div class="panel-heading" style="background-color: #fff;">
                                    <h3 class="panel-title" style="vertical-align: middle; font-size: 12px; font-weight: bold; color: #14599f; letter-spacing: 3px;">
                                        <i class="fa fa-fw fa-share"></i>&nbsp; New Members - PY 2022-23
                                    </h3>
                                </div>
                                            ...
                                            <%  String camp = "";
                                                ...
                                                try {
                                                    ...
                                                    String query1 = "select nvl(to_char(member_since,'DD/MM/YYYY'),'NA') member_since1,"
                                                            ...
                                                            + "(select distinct state_asso from camps_master where upper(camp)=upper(a.camp)) state_asso,"
                                                            + "(select distinct region from camps_master where upper(camp)=upper(a.camp)) region,"
                                                            + "(select distinct area from camps_master where upper(camp)=upper(a.camp)) area,"
                                                            + "(select distinct sa_no from camps_master where upper(camp)=upper(a.camp)) sa_no,"
                                                            ...
                                                            + "a.* from MEMBERSHIP_NM_SUNITHA_NOV a order by sa_no,region,area,camp,mid";
//                                                    System.out.println("New Members 2022_23 : " + query1);
