<%-- 
    Document   : DownloadCampPerformanceDetailedReport_2020_21
    Created on : 04-Nov-2020, 6:59:00 am
...
<%
    ...
    try {
        ...
        while (resultSet.next()) {
            filename = "Camp wise Performance Report " + resultSet.getString("downloaded_on") + ".xls";
        }
        resultSet.close();
        stmt.close();
        conn.close();
                ...
                <div class="table-responsive" style="vertical-align: middle; height: 480px; background-color: #fff;">
                    <table id="summary" class="table table-bordered table-responsive table-hover" border="1">
                        <thead style="background-color: #01354a; color: #ffe114;">   
                            <tr>
                                <th colspan="83" style="background-color: yellow; border-color: #fff; color: #01354a; "><h3><B>CAMP WISE : 2023-24 PERFORMANCE REPORT - DETAILED</B></h3></th>
                            </tr>   
                            <tr>
                                ...
                                <th colspan="6"  style="text-align: center; vertical-align: middle; font-weight: bold;  background-color: khaki; border-color: #fff; color: #01354a;">Gideon New Memberships</th>
                                <th colspan="8"  style="text-align: center; vertical-align: middle; font-weight: bold;  background-color: #ffffd4; border-color: #fff; color: #01354a;">Gideon Membership Report</th>
                                ...
                                <th colspan="8"  style="text-align: center; vertical-align: middle; font-weight: bold;  background-color: #ffe9ec; border-color: #fff; color: #01354a;">Auxiliary Membership Report</th>
                            ...
                            <tr>                                               
                                ...
                                <th style=" background-color: #ededff; border-color: #fff; color: #01354a;" nowrap>Camp Name</th>  
                                ...
                                <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance<br>001 Jan 2024</th> 
                                ...
                                <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance<br>001 Jan 2024</th> 
                                ...
                                <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Heart Program</th>  
                                <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Goal</th>
                                <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Actual</th>
                                <th style="text-align: center;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>%</th> 
                            </tr>
                        ...
                        <tr style="background-color: #01354a; font-weight: bold;  color: rgb(255, 225, 20);" >
                            ...
                            %>
                        <tr style="background-color: #01354a; font-weight: bold;  color: rgb(255, 225, 20);" hidden>
                            <td colspan="4" style="text-align: right;">SA<%=display_value%> - Total&nbsp; </td>
                            <%
                        ...
                        <tr>
                            ...
                            <td style="" nowrap><%=display_camp%></td>
                            <%
                                }
                            %>
