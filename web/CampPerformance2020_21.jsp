...
<html>
    <head>
        ...
        <title>2020_21 Camp Parameters</title>
    ...
    <body style="background-color: #fff; width: 100%;" id="myContainer">
        ...
        <section class="container-fluid" style="padding-top: 20px" >   
            <p style="font-size: 14px; font-weight: bold; color: blue; margin-left: 5px;">Camp Parameters : PY 2020-21</p> 
            <div class='panel panel-default panel-accent-gold'>   
                <div class="panel-body">
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <div class="container-fluid final" id="final">
                                                                ...
                                                                <% String submitted_on = "";
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        query1 = "SELECT rid,modified_on submitted_on,e503month||'-'||e503year e503_month,initcap(camp) camp,"
                                                                                ...
                                                                                + "tallydate,nvl(tallyremarks,'-') tally_remarks FROM E503_OVERALL where upper(camp) = upper('" + camp + "') order by modified_on";
