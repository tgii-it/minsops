                        ...
                        <table id="2022_23" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>    
                                    ...
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>30 Apr 2023</th> 
                                    ...
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>30 Apr 2023</th> 
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        sql = "select rownum slno,nvl(pwt_sf,'0') pwt_sf,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                ...
                                                + "nvl((select gid_dropped from V_DROPPED_2022_23_2 where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') gid_ytr,"
                                                + "nvl((select aux_dropped from V_DROPPED_2022_23_2 where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') aux_ytr,"
                                                + "nvl((select friends from Friends_NPR_apr_2022_23_final where zone=a.zone and sa_no=a.sa_no),'0') friends,"
