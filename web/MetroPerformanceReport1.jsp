            ...
            <div class='panel panel-default panel-accent-gold'>
                <div class="panel-heading" style="background-color: #fff;">
                    <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                        <i class="fa fa-fw fa-share"></i>&nbsp; Metro Performance Report
                    </h3>
                </div>
                <div class="panel-body" style="padding-top: 10px; width: 100%"> 
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" style="font-size: 12px; font-weight: bold;" href="#PY2021-22">EM</a></li>
                        <li><a data-toggle="tab" style="font-size: 12px; font-weight: bold;" href="#PY2020-21">Metro</a></li>
                        <li class="dropdown"><a href="#detailed_tab" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Download &nbsp; <span class="caret"></span></a>
                            <ul class="dropdown-menu dmenu">
                                <li><a href="DownloadMetroPerformanceSummaryReport_2021_22.jsp?exportToExcel=YES">EM Summary Report</a></li>
                                <li><a href="DownloadMetroPerformanceDetailedReport_2021_22.jsp?exportToExcel=YES">EM Detailed Report</a></li>
                                <li class="divider"></li>
                                <li><a href="DownloadMetroPerformanceSummaryReport_2021_22.jsp?exportToExcel=YES">Metro Summary Report</a></li>
                                <li><a href="DownloadMetroPerformanceDetailedReport_2021_22.jsp?exportToExcel=YES">Metro Detailed Report</a></li>                                
                            </ul>
                        </li>
                    </ul>
                                        ...
                                        <table id="summary" class="table table-bordered table-responsive table-hover">
                                            <thead style="background-color: #01354a; color: #ffe114;">   
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; vertical-align: middle; font-weight: bold; font-size: 11px; background-color: white; border-color: white; color:white;">&nbsp;</th>
                                                </tr>                                                          
                                                <tr>                                               
                                                    <th style="background-color: #ededff; border-color: #fff; color: #01354a;" nowrap>SA</th>
                                                    ...
                                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Gideon<br>Opening<br>Balance as on<br>01 Nov 2021</th> 
                                                    ...
                                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Auxiliary<br>Opening<br>Balance as on<br>01 Nov 2021</th> 
                                            ...
                                            <%
                                                ...
                                                try {
                                                    conn = ds.getConnection();
                                                    stmt = conn.createStatement();
                                                    sql = "select * from v_Metro_Performance_Report_Table where sno<>'0' and zone is not null "
                                                            + "order by to_number(sno) asc,metrocity";
                                                    System.out.println("Metro Performance Summary Report " + sql);
                                                    ResultSet resultSet = stmt.executeQuery(sql);
                                                    while (resultSet.next()) {
                                                        display_sa = resultSet.getString("sa_no");
                                                        if (resultSet.getString("metrocity").equalsIgnoreCase("zz_SA_Total")) {
                                            %>
                                            ...
                                            <tr>
                                                ...
                                                %>
                                                <td style="text-align: center;" nowrap><%=resultSet.getString("sno")%></td>
