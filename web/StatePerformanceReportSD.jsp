...
<html>
    <head>
        ...
        <title>SD Performance Report</title> 
    ...
    <body style="background-color: #fff;">
        ...
        <section class="container-fluid" style="padding: 60px 2px;" >
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#summary_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa_no1%> -:- Scripture Distribution - Summary Report</a></li>
                <li><a data-toggle="tab" href="#detailed_tab" style="font-size: 12px; font-weight: bold;"><%= v_sa_no1%> -:- Scripture Distribution - Detailed Report</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dmenu">
                        <li><a href="DownloadStatePerformanceSummaryReport_2023_24_SD.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2023-24 SD Summary Report</a></li>
                        <li><a href="DownloadStatePerformanceDetailedReport_2023_24_SD.jsp?StateAsso=<%=v_sa_no%>&exportToExcel=YES">2023-24 SD Detailed Report</a></li>
                    </ul>
                </li>
            </ul>
                        ...
                        <table id="summary" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>                                               
                                    ...
                                    <th  nowrap>Area Director</th>  
                                    <th style="text-align: right;" nowrap>Goal</th> 
                                    <th style="text-align: right;" >Demand Placed</th>
                                    <th style="text-align: right;" >Actual<br>(Shipped + In-Transit)</th>  
