...
<html>
        ...
        <section class="container-fluid" style="padding: 60px 2px;">
            <div class="panel-heading" style="background-color: #fff;">
                <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                    <i class="fa fa-fw fa-share"></i>&nbsp;<font style="color: brown;">Previous Years</font> National Performance Reports
                </h3>
            </div>
            <ul class="nav nav-tabs" style="padding-top: 10px;">
                <li class='active'><a data-toggle="tab" href="#PY2022-23" style="font-size: 12px; font-weight: bold;">2022-23</a></li>
                <li><a data-toggle="tab" href="#PY2021-22" style="font-size: 12px; font-weight: bold;">2021-22</a></li>
                <li><a data-toggle="tab" href="#PY2020-21" style="font-size: 12px; font-weight: bold;">2020-21</a></li>
                <li><a data-toggle="tab" href="#PY2019-20" style="font-size: 12px; font-weight: bold;">2019-20</a></li>
                <li class="dropdown"><a href="#" style="font-size: 12px; font-weight: bold;" class="dropdown-toggle" data-toggle="tab dropdown">Download &nbsp; <span class="caret"></span></a>
                    <ul class="dropdown-menu dmenu">
                        <li><a href="DownloadNationalPerformanceSummaryReport_2022_23.jsp?exportToExcel=YES">2022-23 Yr Performance Report</a></li>
                        <li><a href="DownloadNationalPerformanceSummaryReport_2021_22.jsp?exportToExcel=YES">2021-22 Yr Performance Report</a></li>
            ...
            <div class="tab-content">
                <div id="PY2022-23" class="tab-pane fade in active">
                    <div class="table-responsive" style="vertical-align: middle; font-size: 10px; height: 590px; background-color: #fff; overflow-y: scroll; padding-left: 10px; padding-right:10px;">
                        <p style="padding-left: 10px; font-size: 12px; margin-top:10px; color: blue;"><b>Note :</b>Final report of PY 2022-23</p>
                        <table id="2022_23" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>    
                                    ...
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2023</th> 
                                    ...
                                    <th style="text-align: center; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Dropped<br>[C]</th>
                                    ...
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2023</th> 
                                    ...
                                    <th style="text-align: center; background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Dropped<br>[C]</th>           
                                ...
                                <%                                    String sql = "";
                                    ...
                                    try {
                                        ...
                                        sql = "select rownum slno,nvl(pwt_sf,'0') pwt_sf,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                //                                                + "nvl((select gid_ytr from v_renewal_dashboard_dynamic_values_nat_perf_report_values where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') gid_ytr,"
                                                //                                                + "nvl((select aux_ytr from v_renewal_dashboard_dynamic_values_nat_perf_report_values where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') aux_ytr,"
                                                + "nvl((select gid_dropped from V_DROPPED_2022_23_2_tbl where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') gid_ytr,"
                                                + "nvl((select aux_dropped from V_DROPPED_2022_23_2_tbl where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') aux_ytr,"
                                                + "nvl((select friends from Friends_NPR_may_2022_23_final_tbl where zone=a.zone and sa_no=a.sa_no),'0') friends,"
                                                + "(SELECT EMI_GID FROM v_renewal_dashboard_dynamic_values_tbl_3_2023_23 WHERE ZONE = A.ZONE AND SA_NO = A.SA_NO) EMI_GID,"
                                                + "(SELECT EMI_AUX FROM v_renewal_dashboard_dynamic_values_tbl_3_2023_23 WHERE ZONE=A.ZONE AND SA_NO = A.SA_NO) EMI_AUX,"
                                                ...
                                                + "round(case when Aux_New_Member_goal>0 then round(100*(a_nm/Aux_New_Member_goal),2) else 0 end,0) a_nm_per,round(case when Gid_New_Member_goal>0 then round(100*(g_nm/Gid_New_Member_goal),2) else 0 end,0) g_nm_per,"
                                                ...
                                                + "a.* from V_E503_NATIONAL_SUM_REPORT_B2_2022_23 a order by zone,sa_no";
    ...
    <!--                                    <td style="text-align: center; background-color: lightpink; color: #01354a;" nowrap><%=f.format(taytr)%></td>
                ...
                <div id="PY2021-22" class="tab-pane fade">
                    <div class="table-responsive" style="vertical-align: middle; font-size: 10px; height: 590px; background-color: #fff; overflow-y: scroll; padding-left: 10px; padding-right:10px;">
                        <p style="padding-left: 10px; font-size: 12px; margin-top:10px; color: blue;"><b>Note :</b>Final report of PY 2021-22</p>
                        <table id="2021_22" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>    
                                    ...
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2022</th> 
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Received</th>  
                                    <th style="text-align: center; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>%</th>  
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>EMI</th>   
                                    ...
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2022</th> 
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Received</th> 
                                    <th style="text-align: center;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>%</th>      
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>EMI</th>     
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        sql = "select rownum slno,nvl(pwt_sf,'0') pwt_sf,(nvl(ffr_actual,'0')+nvl(ffo_actual,'0')) ffr_ffo,"
                                                ...
                                                + "nvl((select gid_ytr from v_MEMBERSHIP_WEEKLY_RAW_dropped_members_28April2022_5 where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') gid_ytr,"
                                                + "nvl((select aux_ytr from v_MEMBERSHIP_WEEKLY_RAW_dropped_members_28April2022_5 where zone=a.zone and sa_no=decode(a.sa_no,'17','Zone_Total',a.sa_no)),'0') aux_ytr,"
                                                + "nvl((select friends from Friends_NPR_2021_22_final where zone=a.zone and sa_no=a.sa_no),'0') friends,"
                                                ...
                                                + "round(case when ffr_goal>0 then round(100*((nvl(ffr_actual,'0')+nvl(ffo_actual,'0'))/ffr_goal),2) else 0 end,0) ffr_per,"
                                                + "round(case when pab_goal>0 then round(100*(pab_actual/pab_goal),2) else 0 end,0) pab_per,round(case when gcbp_goal>0 then round(100*(gcbp_actual/gcbp_goal),2) else 0 end,0) gcbp_per,round(case when ffg_goal>0 then round(100*(ffg_actual/ffg_goal),2) else 0 end,0) ffg_per,round(case when ffa_goal>0 then round(100*(ffa_actual/ffa_goal),2) else 0 end,0) ffa_per,round(case when aux_sf_goal>0 then round(100*(aux_sf_actual/aux_sf_goal),2) else 0 end,0) aux_sf_per,round(case when aux_pwt_goal>0 then round(100*(aux_pwt_actual/aux_pwt_goal),2) else 0 end,0) aux_pwt_per,(total_life+total_annual) total_memberships,nvl(pwt_sf,'0') pwt_sf,"
                                                + "a.* from V_E503_NATIONAL_SUM_REPORT_B2_2021_22 a order by zone,sa_no";
                        ...
                        <table id="2020_21" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">   
                                ...
                                <tr>    
                                    ...
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2020</th> 
                                    ...
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2020</th> 
                        ...
                        <table id="2019_20" class="table table-bordered table-responsive table-hover">
                            <thead style="background-color: #01354a; color: #ffe114;">  
                                ...
                                <tr>    
                                    ...
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2019</th> 
                                    <th style="text-align: right; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>Renewals<br>Received</th>   
                                    <th style="text-align: center; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>%</th>    
                                    <th style="text-align: center; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>New<br>Members<br>Goal</th>   
                                    <th style="text-align: center; background-color: #ffffd4; border-color: #fff; color: #01354a;" nowrap>PSU</th>    
                                    ...
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Opening<br>Balance as on<br>31 May 2019</th> 
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Renewals<br>Received</th>     
                                    <th style="text-align: center;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>Auxiliary<br>Renewals<br>%</th>  
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>New<br>Members<br>Goal</th> 
                                    <th style="text-align: right;  background-color: #ffe9ec; border-color: #fff; color: #01354a;" nowrap>PSU</th> 
