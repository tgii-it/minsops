...
<html>
    <head>
        ...
        <title>2023_24 RENEWALS DASHBOARD</title>
                    ...
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                ...
                                <i class="fa fa-fw fa-share"></i>&nbsp; 2023_24 RENEWALS DASHBOARD (INCLUDING DEFERRED PAYMENTS) 
                            </h3>
                        </div>
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sql = "select a.*,"
                                                    ...
                                                    + "from v_renewal_dashboard_dynamic_values a order by to_number(sa_no) asc";
//                                            System.out.println("RenewalDB'23 : " + sql);
                                            ...
                                            while (resultSet.next()) {
                                                ...
                                                if (sa_no.equalsIgnoreCase("14")) {
                                                    sa_no = "OS";
                                                } else if (sa_no.equalsIgnoreCase("15")) {
                                                    sa_no = "Overall_Total";
                                                } else {
                                                    sa_no = "SA" + sa_no;
                                                }
                                                slno_sa_o = slno_sa_o + 1;
                                                if (sa_no.equalsIgnoreCase("Overall_Total")) {
                                    %>
                                    ...
                                    <tr>
                                        <td hidden><%= resultSet.getString("sa_no")%></td>
                                        <td style="font-weight: bold; text-align: center;" nowrap><%= sa_no%></td>
                                        <td style="text-align: center; background-color:#F2FAD8; font-weight: bold;" nowrap><%=resultSet.getString("total_gideon")%></td>
                                        <td nowrap><%=resultSet.getString("ir_gideon")%></td>
                                        <td nowrap><%=resultSet.getString("ins_gideon")%></td>
                                        <td nowrap><%=resultSet.getString("dr_gideon")%></td>
        ...
        <script>
            $(document).ready(function () {
                ...
                gideons = $('#gideons').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1grnew1/gideonRenewalsNew1Json/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "mid"},
        ...
        <script>
            $(document).ready(function () {
                ...
                auxiliary = $('#auxiliary').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1arnew1/auxRenewalsNew1Json/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "mid"},
