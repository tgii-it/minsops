...
<html>
    <head>
        ...
        <title>TGII | Direct Reinstated Processing page..</title>
                ...
                <div class='panel panel-default panel-accent-gold'>
                    <div class="panel-heading" style="background-color: #fff;">
                        <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                            <i class="fa fa-fw fa-share"></i>&nbsp; Process Direct ReInstated Request
                        </h3>
                    </div>

                    <form name="frm_apply" method="post" action="DirectReInstatedCampWise.jsp">
                    ...
                    <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; color: black; height: auto;">
                        <form name="frm_apply" method="post" action="ProcessE503ReinstlRequest" onsubmit="return validateCheckbox(this)">
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            con = ds.getConnection();
                                            Statement statement = con.createStatement();
                                            String sql = "select to_char(annual_start_date,'dd-mm-yyyy') annual_start_date, to_char(annual_end_date,'dd-mm-yyyy') annual_end_date, a.* from membership_weekly_raw a where upper(a.camp)=Upper('" + camp + "') and status='Dropped' order by mid";
