...
<html>
    <head>
        ...
        <title>2022_23 Camp Report</title>
    ...
    <body style="background-color: #fff; width: 100%;" id="myContainer">
        ...
        <section class="container-fluid" style="padding-top: 20px" >  
            <p style="font-size: 14px; font-weight: bold; color: blue; margin-left: 5px;">Camp Report : PY 2022_23</p>       
        ...
        <script>
            $(function () {
                $('#camp').change(function () {
                    ...
                    var camp = $("#camp").val();
                    $.ajax({
                        url: 'CampDashboard2022?camp=' + camp,
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
