...
<%  String useraccessname = "";
    ...
    } else if (OBJ.equals("Sucharitha") || OBJ.equals("Ambica") || OBJ.equals("Anbalagan") || OBJ.equals("Mr Sam Varghese") || OBJ.equals("Sunitha")) {
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" style="padding: 60px 0px;">
            <div class="container-fluid">   
                <div class="row">
                    <div class="col-md-12">
                        <form name="frm2" method="post" action="designationUpdate.jsp">                      
                                        ...
                                        <tbody id='mytab' class="table-search"> 
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    ResultSet rs = null;
                                                    String sql = "select nvl(state,'NA') state,camp,mid,nvl(phone,'0') mobile,nvl(email,'NA') email,nvl(designation,'Member') designation,mtype,status,name from membership_weekly_raw where upper(camp) = upper('" + v_camp + "') and status in ('Current','Grace') order by mid";
                            ...
                            <div class='panel panel-default panel-accent-gold'>
                                ...
                                <div class="panel-body" style="padding-top: 20px;"> 
                                    <div class="form-group col-lg-12">     
                                        <div class="form-row">                                     
                                            <div class="form-group col-md-3">
                                                <label for="memtype">New Designation</label>
                                                <!--<div class='input-group'>
                                                    <span class="input-group-addon">
                                                    ...
                                                    <select class="form-control" name="new_designation" id="new_designation">
                                                        ...
                                                        <option value="CAMP PRESIDENT">Camp President</option>
                                                        <option value="CAMP VICE PRESIDENT">Camp Vice President</option>
                                                        <option value="CAMP SECRETARY">Camp Secretary</option>
                                                        <option value="CAMP TREASURER">Camp Treasurer</option>
                                                        <option value="CAMP CHAPLAIN">Camp Chaplain</option>
                                                        <option value="CAMP AUX PRESIDENT">Camp Aux President</option>
                                                        <option value="CAMP AUX VICE PRESIDENT">Camp Aux Vice President</option>
                                                        <option value="CAMP AUX SECRETARY">Camp Aux Secretary</option>
                                                        <option value="CAMP AUX CHAPLAIN">Camp Aux Chaplain</option>
                                                        <option value="CAMP AUX SD CHAIRMAN">Camp Aux SD Chairman</option>
                                                        <option value="CAMP MEMBERSHIP CHAIRMAN">Camp Membership Chairman</option>
                                                        <option value="CAMP FAITH FUND CHAIRMAN">Camp Faith Fund Chairman</option>
                                                        <option value="CAMP SD CHAIRMAN">Camp SD Chairman</option>
                                                        <option value="CAMP CHURCH MINISTRY CHAIRMAN">Camp Church Ministry Chairman</option>
                                                        <option value="CAMP GCBP CHAIRMAN">Camp GCBP Chairman</option>
                                                        <option value="CAMP WEBMASTER">Camp Webmaster</option>
                                                ...
                                                <div class='input-group'>
                                                    ...
                                                    <%  String gideon_sql = "";
                                                        ...
                                                        try {
                                                            con = ds.getConnection();
                                                            Statement statement = con.createStatement();
                                                            gideon_sql = "select distinct designation from gmap_all_officers "
                                                                    //  + "where sa in (11,12,13) "
                                                                    + "order by designation";
                                                            ResultSet resultSet = statement.executeQuery(gideon_sql);
                                                    %>
                                                    <input name="new_designation" list="mDesignation" class="form-control" id="new_designation">
