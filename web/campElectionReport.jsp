...
<html>
    <head>
        ...
        <title>Camp Election Report</title>
    ...
    <body style="background-color: #fff; width: 100%;">
        ...
        <section id="main" class="container-fluid" style="padding: 60px 0px;">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#sa_wise_cnt" style="font-size: 12px; font-weight: bold;">SA wise</a></li>
                <li><a data-toggle="tab" href="#sa_wise_cnt1" style="font-size: 12px; font-weight: bold;">Region wise</a></li>
                <li><a data-toggle="tab" href="#sa_wise_cnt2" style="font-size: 12px; font-weight: bold;">Area wise</a></li>
                <li><a data-toggle="tab" href="#gid_list" style="font-size: 12px; font-weight: bold;">Election_conducted_list</a></li>
                <li><a data-toggle="tab" href="#aux_list" style="font-size: 12px; font-weight: bold;">Yet_to_conduct_list   </a></li>
            </ul>
            <div class="tab-content">
                    ...
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                ...
                                <i class="fa fa-fw fa-share"></i>&nbsp; CAMP ELECTION REPORT (SA wise) : PY 2023-24 
                            </h3>
                        </div>
                            ...
                            <table id="sacnt" class="table table-bordered table-responsive table-hover table-striped" style="width: 100%;">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        ...
                                        <th style="text-align: center;" nowrap>States</th>
                                        <th style="text-align: center;" nowrap>Total_camps</th>
                                        <th style="text-align: center;" nowrap>Conducted_Camps</th>
                                        <th style="text-align: center;" nowrap>Yet_to_Conduct Camps</th>
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            ...
                                            //  cstmt.execute();
                                            String sql = "select a.*,round(100*(election_conducted/total_camps),2) per from v_camp_election_details_sa a";

                                            ResultSet resultSet = statement.executeQuery(sql);
                                            while (resultSet.next()) {
                                                sa = resultSet.getString("sa");
                                                sa_no = resultSet.getString("sa_no");
                                                total_camps = resultSet.getString("total_camps");
                                                conducted = resultSet.getString("election_conducted");
                                                yet_to_conduct = resultSet.getString("yet_to_conduct");
                                                per = resultSet.getString("per");
                                                slno_sa_o = slno_sa_o + 1;
                                    %>
                                    <tr style="text-align: center; color: black;">
                                        <td hidden><%= resultSet.getString("sa_no")%></td>
                                        <td nowrap><%= sa%></td>
                                        <td nowrap><%=total_camps%></td>
                                        <td nowrap><%=conducted%></td>
                                        <td nowrap><%=yet_to_conduct%></td>
                                        <td nowrap><%=per%> %</td>
                                    </tr>
                                    <%
                                            }
                ...
                <div id="sa_wise_cnt1" class="tab-pane fade"> 
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp; CAMP ELECTION REPORT (Region wise) : PY 2023-24 
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="sacnt1" class="table table-bordered table-responsive table-hover table-striped" style="width: 90%;">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        <th style="text-align: center;" hidden>Sl_No</th>
                                        <th style="text-align: center;" nowrap>States</th>
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sql = "select a.*,round(100*(election_conducted/total_camps),2) per from v_camp_election_details a";
                ...
                <div id="sa_wise_cnt2" class="tab-pane fade"> 
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp; CAMP ELECTION REPORT (Area wise) : PY 2023-24 
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="sacnt2" class="table table-bordered table-responsive table-hover table-striped" style="width: 90%;">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        <th style="text-align: center;" hidden>Sl_No</th>
                                        <th style="text-align: center;" nowrap>States</th>
                                ...
                                <tbody id='mytab' class="table-search"> 
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sql = "select a.*,round(100*(election_conducted/total_camps),2) per from v_camp_election_details_area a";
                ...
                <div id="gid_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp; CONDUCTED LIST
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
                            <table id="gideons" style="float: left; width: 100%" class="table table-bordered table-responsive table-hover">
                                <thead style="background-color: #01354a; color: #ffe114;">
                                    <tr>
                                        ...
                                        <th nowrap>AREA</th>
                                        <th nowrap>CAMP</th>  
                                        <th nowrap>PERF_YEAR</th>   
                                        <th nowrap>ELECTION_DATE</th>    
                                        <th nowrap>MODIFIED_ON</th>                  
                                    </tr>
                                </thead> 
                ...
                <div id="aux_list" class="tab-pane fade">   
                    <div class='panel panel-default panel-accent-gold' style="padding: 10px;">
                        <div class="panel-heading" style="background-color: #fff;">
                            <h3 class="panel-title" style="vertical-align: middle; font-size: 14px; font-weight: bold; color: #14599f; letter-spacing: 2px;">
                                <i class="fa fa-fw fa-share"></i>&nbsp; YET TO CONDUCT LIST
                            </h3>
                        </div>
                        <div class="table-responsive" style="padding: 10px; vertical-align: middle; font-size: 11px; height: auto;">
            ...
            $(document).ready(function () {
                var table = $('#sacnt').DataTable({
                    ...
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        $(api.column(1).footer()).html(total2);
                        $(api.column(2).footer()).html(total3);
                        $(api.column(3).footer()).html(total4);
                    }
                });
            });
        </script>
        ...
        <script>
            $(document).ready(function () {
                ...
                gideons = $('#gideons').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1elconlist/electionconduectedlist/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "zone"},
        ...
        <script>
            $(document).ready(function () {
                ...
                auxiliary = $('#auxiliary').DataTable({
                    ...
                    ajax: {
                        method: "GET",
                        url: "https://lxxncu6awrxkpqa-db202010270820.adb.ap-hyderabad-1.oraclecloudapps.com/ords/admin/rest-v1elyetlist/electionyettoconductlist/",
                        dataSrc: "items"
                    },
                    columns: [
                        {"data": "zone"},
