...
public class CampDashboard2022 extends HttpServlet {

    private static final long serialVersionUID = 1L;

    public CampDashboard2022() {
        super();
        ...
        try {
            ...
            if (camp != null && camp != "" && !camp.isEmpty()) {
                query = "select round(case when Memberships_Aux_Goal>0 then round(100*(Total_Auxiliary/Memberships_Aux_Goal),2) else 0 end,0)||'%' Memberships_Aux_per,"
                        ...
                        + "a.* from STATE_Detailed_Report_22_23fa_May31_Year_End_2022_23 a "
            ...
            System.out.println("MinsOps Module CampDashboard2023 Q :" + query);
