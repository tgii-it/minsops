 ...
 */
public class PrinteApplication extends HttpServlet {
  ...
  * Method to create a datasource after the JNDI lookup
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //    File f = new File("/home/gideons1/appservers/apache-tomcat-8x/webapps/ROOT/mis/SupDoc/GP" + no);
            ...
            String query = "select decode(trbank,'','NA',trbank) trbank,decode(to_char(trdate,'dd/mm/yyyy'),'','NA',to_char(trdate,'dd/mm/yyyy')) trdate,"
                    + "decode(trno,'','NA',trno) trno,to_char(gdob,'dd/mm/yyyy') gdob,to_char(adob,'dd/mm/yyyy') adob,to_char(trdate,'dd/mm/yyyy') trdate,"
                    + "rid icici_trno,rid icici_trdate,rid icici_paymode,a.* from membership_eform_new a where a.rid='" + no + "' and rownum<2";
...
// title,space(rs=4),photo(rs=4),appno,address, note1,linkno, note2
            ...
            if (f.exists()) {
                // img_photo = Image.getInstance("/home/gideons1/appservers/apache-tomcat-8x/webapps/ROOT/mis/SupDoc/GP" + no);
                img_photo = Image.getInstance("F:\\mis_images\\" + no);
...
//            itbl3.addCell(icell3);
            ...
            icell3.setVerticalAlignment(Element.ALIGN_MIDDLE);
            itbl3.addCell(icell3);
            icell3 = new PdfPCell(new Phrase(":\t" + gmobile + "\t\t DoB : " + gdob, f_header9));
            icell3.setLeading(2f, 1f);
            icell3.setPadding(2);
            icell3.setColspan(1);
            icell3.setBorder(0);
