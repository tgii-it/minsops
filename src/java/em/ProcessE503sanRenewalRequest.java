 ...
 */
public class ProcessE503sanRenewalRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < chkbox.length; i++) {
                mid = chkbox[i];
                reply[i] = da.CallMemStatusUpdate_e503(camp, name, mid, phone, email, mtype, status, annual_end_date, renewalStatus, memtype, startdate, enddate, contactperson, remarks, annual_start_date, mobile2, mobile3, useraccessname, signup_type, credited_to);
            ...
            if (failure_list.equals("")) {
                response.sendRedirect("PendingRenewals.jsp?msg=Success&camp=" + camp + "&SessionIn=" + session.getId());
            }
