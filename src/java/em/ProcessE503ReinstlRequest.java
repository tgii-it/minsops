 ...
 */
public class ProcessE503ReinstlRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (failure_list.equals("")) {
                response.sendRedirect("DirectReInstatedCampWise.jsp?msg=Success&camp=" + camp + "&SessionIn=" + session.getId());
            }
