 ...
 */
public class PrintewpaApplication extends HttpServlet {
  ...
  * Method to create a datasource after the JNDI lookup
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "select decode(trbank,'','NA',trbank) trbank,decode(to_char(trdate,'dd/mm/yyyy'),'','NA',to_char(trdate,'dd/mm/yyyy')) trdate,"
                    + "decode(trno,'','NA',trno) trno,to_char(gdob,'dd/mm/yyyy') gdob,to_char(adob,'dd/mm/yyyy') adob,PG_GET_DMF_REFNO(rid,MFEE) icici_trno,"
                    + "PG_GET_DMF_TRDATE(rid,MFEE) icici_trdate,PG_GET_DMF_PAYMODE(rid,MFEE) icici_paymode,a.* "
                    + "from membership_eform_new a where a.rid='" + no + "' and rownum<2";
            System.out.println("wpa " + query);
            try {
...
// Fonts
            ...
            f_header12BC.setColor(97, 11, 11);
            ...
            f_header11BC.setColor(97, 11, 11);
            Font f_header10C = new Font();
            f_header10C.setSize(10);
            f_header10C.setColor(97, 11, 11);
            ...
            f_header8BC.setColor(97, 11, 11);
            Font f_header7 = new Font();
            f_header7.setSize(7);
            f_header7.setColor(97, 11, 11);
            Font f_header6 = new Font();
            f_header6.setSize(6);
            f_header6.setColor(97, 11, 11);
// PDF Related
...
// Row 1 - Header 
            ...
            String head2 = "Auxiliary Membership Application Form\n";
            ...
            cell.setBorderColor(new Color(97, 11, 11));
...
// title,space(rs=4),photo(rs=4),appno,address, note1,linkno, note2
            ...
            cell.setBorder(Cell.BOX);
            cell.setBorderColor(new Color(97, 11, 11));
            cell.setBackgroundColor(new Color(248, 224, 224));
...
// appno and address
            ...
            itbl3.addCell(icell3);
            icell3 = new PdfPCell(new Phrase(":\t" + auxname + " (" + gid + ")", f_header9));
            icell3.setLeading(2f, 1f);
            icell3.setPadding(2);
            icell3.setColspan(1);
            icell3.setBorder(0);
...
//            itbl3.addCell(icell3);
            ...
            icell3.setVerticalAlignment(Element.ALIGN_MIDDLE);
            itbl3.addCell(icell3);
            icell3 = new PdfPCell(new Phrase(":\t" + amobile + "\t\t Email : " + aemail, f_header9));
            icell3.setLeading(2f, 1f);
            icell3.setPadding(2);
            icell3.setColspan(1);
            icell3.setBorder(0);
            ...
            icell3.setVerticalAlignment(Element.ALIGN_MIDDLE);
            itbl3.addCell(icell3);
            icell3 = new PdfPCell(new Phrase(":\t" + awmobile + "\t\t DoB : " + adob, f_header9));
            icell3.setLeading(2f, 1f);
            icell3.setPadding(2);
            icell3.setColspan(1);
            icell3.setBorder(0);
...
// Section 2 starts here
            ...
            outerCell.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell.setColspan(1);
            outerCell.setBorder(Cell.BOX);
            outerCell.setBackgroundColor(new Color(248, 224, 224));
            outerCell.setBorderColor(new Color(97, 11, 11));
...
// Section _3 starts here
            ...
            outerCell_3.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell_3.setColspan(1);
            outerCell_3.setBorder(Cell.BOX);
            outerCell_3.setBackgroundColor(new Color(248, 224, 224));
            outerCell_3.setBorderColor(new Color(97, 11, 11));
...
// Section _4 starts here
            ...
            outerCell_4.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell_4.setColspan(1);
            outerCell_4.setBorder(Cell.BOX);
            outerCell_4.setBackgroundColor(new Color(248, 224, 224));
            outerCell_4.setBorderColor(new Color(97, 11, 11));
...
// Section _5 starts here
            ...
            outerCell_5.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell_5.setColspan(1);
            outerCell_5.setBorder(Cell.BOX);
            outerCell_5.setBackgroundColor(new Color(248, 224, 224));
            outerCell_5.setBorderColor(new Color(97, 11, 11));
...
// Section _6 starts here
            ...
            outerCell_6.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell_6.setColspan(1);
            outerCell_6.setBorder(Cell.BOX);
            outerCell_6.setBackgroundColor(new Color(248, 224, 224));
            outerCell_6.setBorderColor(new Color(97, 11, 11));
...
// Section _7 starts here
            ...
            outerCell_7.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell_7.setColspan(1);
            outerCell_7.setBorder(Cell.BOX);
            outerCell_7.setBackgroundColor(new Color(248, 224, 224));
            outerCell_7.setBorderColor(new Color(97, 11, 11));
...
// Section _8 starts here
            ...
            outerCell_8.setBorderColor(new Color(97, 11, 11));
            ...
            outerCell_8.setColspan(1);
            outerCell_8.setBorder(Cell.BOX);
            outerCell_8.setBackgroundColor(new Color(248, 224, 224));
            outerCell_8.setBorderColor(new Color(97, 11, 11));
